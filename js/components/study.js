...
*/
import { STAGES } from '../data/questions.js?v=2026072109';
import { resolveStudyBeats } from '../data/studyBeats.js';
import { state, progress, saveProgress, esc, MEDAL_RANK, recordLearningActivity } from '../core/state.js?v=2026072109';
