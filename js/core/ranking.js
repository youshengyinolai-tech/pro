...
*/
import { STAGES, TOTAL_STARS } from '../data/questions.js?v=2026072108';
import { progress, saveProgress, totalStarsEarned, learningActivitySummary } from './state.js?v=2026072108';
