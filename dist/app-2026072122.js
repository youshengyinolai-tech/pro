var he=[{id:"w1",title:"CASE 01「消えた出力」",sub:"Week1 C++の入出力",emoji:"👺",mon:"何も表示しない男",lesson:[{title:"画面に文字を出す",code:`#include <iostream>
using namespace std;
int main(){
...
app.pack()
root.mainloop()`],explain:"このファイルが直接実行されたときだけ動く定番のイディオムの中で、ウィンドウを用意し、自作ウィジェットクラスSettingsPanelを生成して配置し、mainloop()で操作を待ち受けます。"}]};Object.keys(ve).forEach(function(e){ve[e].forEach(function(n,a){n.unit="boss:"+e,n.diff=4,n.qid="boss:"+e+":"+a})});var ta=new Set(["w4:qs:11","w7:qsHard:8","w8:qsHard:8","w8:qsHard:14","w9:qsExtra:32","w2:qsExtra:51","wb:qsExtra:28","wb:qsExtra:33","py:qsExpert:12","w7:qsExtra:36"]);function Ye(e){return!!e&&ta.has(e.qid)}function tt(e){var n=[e.lead||"",e.before||"",e.code||"",e.after||""].concat((e.lines||[]).map(function(a){return a.code||""})).concat(e.answers||[]).join(`
`).toLowerCase().normalize("NFKC").replace(/\s+/g,"").replace(/[0-9]+/g,"#").replace(/[a-z_][a-z0-9_]*/g,"v").replace(/[^\p{L}\p{N}#]/gu,"");return(e.type||"fill")+"|"+n}function aa(e){for(var n=2166136261,a=0;a<e.length;a++)n^=e.charCodeAt(a),n=Math.imul(n,16777619);return"sim-"+(n>>>0).toString(36)}var ra={},ue={};he.forEach(function(e){Jn.concat(["qsDrag"]).forEach(function(n){(e[n]||[]).forEach(function(a){var i=tt(a);ue[i]||(ue[i]=[]),ue[i].push(a)})})});Object.keys(ve).forEach(function(e){ve[e].forEach(function(n){var a=tt(n);ue[a]||(ue[a]=[]),ue[a].push(n)})});Object.keys(ue).forEach(function(e){var n=ue[e];if(!(n.length<2)){var a=aa(e);n.forEach(function(i){i.similarityTag=a,ra[i.qid]=a})}});function ee(e){return e&&e.similarityTag||null}function ia(e){var n=e.ids.map(function(s){return he[s]}),a=[];n.forEach(function(s){s.lesson.forEach(function(o){a.push({title:"『"+s.title+"』"+o.title,code:o.code,explain:o.explain})})});var i=[];return n.forEach(function(s){for(var o=s.qs.slice(),l=o.length-1;l>0;l--){var u=Math.floor(Math.random()*(l+1)),b=o[l];o[l]=o[u],o[u]=b}i=i.concat(o.slice(0,8))}),i=i.concat(ve[e.id]||[]),{id:e.id,title:e.title,sub:e.sub,emoji:e.emoji,mon:e.mon,isBoss:!0,lesson:a,qs:i}}var D=[];(function(){var e=0;he.forEach(function(n,a){D.push(n);var i=Dn[e];i&&a===i.ids[i.ids.length-1]&&(D.push(ia(i)),e++)})})();var q=D.length*3;var ot="oopExamQuest_v3",j=[];function Be(e){Ye(e.q)||j.push(e)}he.forEach(function(e){e.qs.forEach(function(n){Be({q:n,unit:n.unit,diff:n.diff,tier:re(n,"qs"),srcTitle:e.title,srcSub:e.sub})}),(e.qsHard||[]).forEach(function(n){Be({q:n,unit:n.unit,diff:n.diff,tier:re(n,"qsHard"),srcTitle:e.title,srcSub:e.sub+" ・ 難問"})}),(e.qsExtra||[]).forEach(function(n){Be({q:n,unit:n.unit,diff:n.diff,tier:re(n,"qsExtra"),srcTitle:e.title,srcSub:e.sub+" ・ 総復習演習"})}),(e.qsExpert||[]).forEach(function(n){Be({q:n,unit:n.unit,diff:n.diff,tier:re(n,"qsExpert"),srcTitle:e.title,srcSub:e.sub+" ・ 発展演習"})}),(e.qsDrag||[]).forEach(function(n){Be({q:n,unit:n.unit,diff:n.diff,tier:re(n,"qsDrag"),srcTitle:e.title,srcSub:e.sub+" ・ ドラッグ問題"})})});Dn.forEach(function(e){(ve[e.id]||[]).forEach(function(n){Be({q:n,unit:n.unit,diff:n.diff,tier:re(n,"boss"),srcTitle:e.title,srcSub:e.sub+" ・ 総復習"})})});var qe={};j.forEach(function(e,n){qe[e.q.qid]=n});function sa(e){var n=e.type||"fill",a=String(e.answers&&e.answers[0]||""),i=[e.before||"",e.after||"",e.code||"",e.lead||""].concat((e.lines||[]).map(function(g){return g.code||""})).join(`
`),s=i.split(`
`).filter(function(g){return g.trim()}).length,o=a.split(`
`).filter(function(g){return g.trim()}).length,l=(i.match(/\b(?:if|else|for|while|switch|case|return|new|delete|class|template|try|catch)\b/g)||[]).length,u=(i.match(/(?:<<|>>|==|!=|<=|>=|&&|\|\||\+\+|--|[+\-*\/%=<>])/g)||[]).length,b=(i.match(/[()[\]{}]/g)||[]).length,f={choice:-20,fill:0,debug:42,order:34,dragfill:28}[n]||0,y=f+Math.min(125,a.length*.7)+Math.min(90,Math.max(0,o-1)*18)+Math.min(90,s*5)+Math.min(90,l*13)+Math.min(55,u*2.2)+Math.min(45,b*1.4)+Math.min(70,(e.lines||[]).length*9)+Math.min(35,(e.pieces||[]).length*6);return e.long&&(y+=75),e.answers&&e.answers.length>1&&(y-=Math.min(18,(e.answers.length-1)*5)),Math.max(0,y)}var la={1:[100,299],2:[300,499],3:[500,749],4:[750,1e3]},ct={};[1,2,3,4].forEach(function(e){var n=j.filter(function(l){return l.diff===e}),a=n.map(function(l){return sa(l.q)}),i=Math.min.apply(Math,a),s=Math.max.apply(Math,a),o=la[e];n.forEach(function(l,u){var b=s===i?.5:(a[u]-i)/(s-i);ct[l.q.qid]=Math.round(o[0]+b*(o[1]-o[0]))})});function In(e){return ct[e.qid]||100}var Q=he.map(function(e){return{id:e.id,title:e.title,sub:e.sub,emoji:e.emoji}}),Ge={};j.forEach(function(e,n){Ge[e.unit]||(Ge[e.unit]=[]),Ge[e.unit].push(n)});function oa(){try{var e=localStorage.getItem(ot);if(e)return JSON.parse(e)}catch{}return{unlocked:1,stars:{}}}var Hn=!1;function H(e){try{localStorage.setItem(ot,JSON.stringify(e))}catch{}if(typeof window<"u"&&window.dispatchEvent){if(Hn)return;Hn=!0,queueMicrotask(function(){Hn=!1,window.dispatchEvent(new CustomEvent("codecase:progress-saved"))})}}function Ln(e){if(!(!e||typeof e!="object")){var n=t.settings&&t.settings.progressSync,a=t.ranking;Object.keys(t).forEach(function(i){delete t[i]}),Object.keys(e).forEach(function(i){t[i]=e[i]}),t.settings||(t.settings={}),n&&(t.settings.progressSync=n),a&&(t.ranking=a),H(t)}}var t=oa();(!t.endless||!Array.isArray(t.endless.queue))&&(t.endless={queue:[],pos:0,correct:0,wrong:0,streak:0,bestStreak:0});t.endless.adaptiveQueueVersion!==2&&(t.endless.queue=[],t.endless.pos=0,t.endless.adaptiveQueueVersion=2);t.settings||(t.settings={allowAlt:!1,endlessUnits:null,endlessDiffs:null,endlessTiers:null,studyModeActive:!1});"endlessUnits"in t.settings||(t.settings.endlessUnits=null);"endlessDiffs"in t.settings||(t.settings.endlessDiffs=null);"endlessFastMode"in t.settings||(t.settings.endlessFastMode=!0);[0,10,20,50,100].indexOf(t.settings.endlessBatchSize)===-1&&(t.settings.endlessBatchSize=0);t.settings.endlessBatchSizeVersion!==2&&(t.settings.endlessBatchSize=0,t.settings.endlessBatchSizeVersion=2);"endlessTiers"in t.settings||(t.settings.endlessTiers=null);"studyModeActive"in t.settings||(t.settings.studyModeActive=!1);"soloCollapsed"in t.settings||(t.settings.soloCollapsed=!1);"mobileAnswerMode"in t.settings||(t.settings.mobileAnswerMode=!1);t.settings.answerModeVersion!==2&&(t.settings.mobileAnswerMode=!1,t.settings.answerModeVersion=2);t.settings.tierSchemaVersion!==5&&(at={1:[1,2],2:[3],3:[4,5]},Array.isArray(t.settings.endlessTiers)&&t.settings.endlessTiers.length&&(Re=[],t.settings.endlessTiers.forEach(function(e){(at[e]||[]).forEach(function(n){Re.indexOf(n)===-1&&Re.push(n)})}),t.settings.endlessTiers=Re.length?Re:null),t.settings.tierSchemaVersion=5);var at,Re;t.unitStats||(t.unitStats={});t.missed||(t.missed={});t.studyCompleted||(t.studyCompleted={});t.studyMedal||(t.studyMedal={});t.ranking||(t.ranking={nickname:"あなた",rooms:[],activeMetric:"overall"});t.ranking.nickname||(t.ranking.nickname="あなた");(!t.activity||typeof t.activity!="object")&&(t.activity={days:{},bestDayCorrect:0});(!t.activity.days||typeof t.activity.days!="object")&&(t.activity.days={});typeof t.activity.bestDayCorrect!="number"&&(t.activity.bestDayCorrect=0);(!t.showcase||typeof t.showcase!="object")&&(t.showcase={achievementLabels:null});H(t);function Tn(e){var n=e||new Date;return n.getFullYear()+"-"+String(n.getMonth()+1).padStart(2,"0")+"-"+String(n.getDate()).padStart(2,"0")}function ca(e){var n=new Date;return n.setHours(12,0,0,0),n.setDate(n.getDate()-e),Tn(n)}function Ae(e,n){var a=Tn(),i=t.activity.days;i[a]||(i[a]={answers:0,correct:0,studySteps:0,reviewsCleared:0});var s=e||"answers";i[a][s]=(i[a][s]||0)+(typeof n=="number"?n:1),(i[a].correct||0)>t.activity.bestDayCorrect&&(t.activity.bestDayCorrect=i[a].correct)}function pe(){for(var e=Tn(),n=t.activity.days[e]||{answers:0,correct:0,studySteps:0,reviewsCleared:0},a=0,i=(n.answers||0)+(n.studySteps||0)+(n.reviewsCleared||0)>0?0:1,s=i;s<370;s++){var o=t.activity.days[ca(s)];if(!o||(o.answers||0)+(o.studySteps||0)+(o.reviewsCleared||0)===0)break;a++}var l=[{id:"correct",label:"既存問題で5問正解",value:n.correct||0,target:5},{id:"study",label:"学習パートを3ステップ",value:n.studySteps||0,target:3},{id:"review",label:"間違いノートを1問解決",value:n.reviewsCleared||0,target:1}],u=l.filter(function(b){return b.value>=b.target}).length;return{today:n,streak:a,missions:l,completed:u,bestDayCorrect:t.activity.bestDayCorrect||0}}function Ce(){var e=0;Object.keys(t.unitStats||{}).forEach(function(u){e+=t.unitStats[u].correct||0});var n=Object.keys(t.studyCompleted||{}).filter(function(u){return!!t.studyCompleted[u]}).length,a=z()*10+e+n*20,i=[{name:"見習い捜査員",min:0},{name:"コード巡査",min:100},{name:"事件解析官",min:300},{name:"上級デバッガー",min:700},{name:"首席コード探偵",min:1400}],s=i[0],o=null;i.forEach(function(u,b){a>=u.min&&(s=u,o=i[b+1]||null)});var l=o?Math.max(0,Math.min(100,Math.round((a-s.min)/(o.min-s.min)*100))):100;return{name:s.name,points:a,next:o,percent:l}}function dt(e,n){e&&(t.unitStats[e]||(t.unitStats[e]={correct:0,wrong:0}),n?t.unitStats[e].correct++:t.unitStats[e].wrong++,Ae("answers",1),n&&Ae("correct",1))}function ut(e,n){e&&(n||(t.missed[e]=!0))}function F(){return Object.keys(t.missed).length}function pt(e){var n=t.unitStats[e],a=n?n.correct+n.wrong:0,i=a>0?n.wrong/a:.35;return 1+i*3}function Ke(e){var n=t.unitStats[e],a=n?n.correct+n.wrong:0;return{total:a,wrongRate:a>0?n.wrong/a:null}}function W(e){var n=e&&e.length?e:Q.map(function(o){return o.id}),a=0,i=0;if(n.forEach(function(o){var l=t.unitStats[o];l&&(a+=l.wrong,i+=l.correct+l.wrong)}),i<5)return 1;var s=a/i;return s>.5?1:s>.3?2:s>.15?3:4}function ft(e){var n=typeof e=="number"?e:.3,a=Q.map(function(i){return i.id}).filter(function(i){var s=Ke(i);return s.total===0||s.wrongRate>n});return a.length?a:Q.map(function(i){return i.id})}function da(e){return e.map(function(n){var a=pt(j[n].unit),i=Math.pow(Math.random(),1/a);return{i:n,key:i}}).sort(function(n,a){return a.key-n.key}).map(function(n){return n.i})}function Mn(e){var n=Ke(e);return n.total<5?1+n.total*.15:Math.max(1,Math.min(4,4-n.wrongRate*5))}function ua(e){var n=Mn(e.unit),a=100+(n-1)*300,i=(In(e.q)-a)/145;return pt(e.unit)*(.025+Math.exp(-.5*i*i))}function rt(e,n){for(var a=e.slice(),i=[],s=(n||[]).slice(-6);a.length;){var o=a.findIndex(function(b){var f=ee(j[b].q);return!f||s.indexOf(f)===-1});o<0&&(o=0);var l=a.splice(o,1)[0],u=ee(j[l].q);i.push(l),u&&(s.push(u),s=s.slice(-6))}return i}function pa(e,n){for(var a=e.slice(),i=[];a.length;){var s=a.findIndex(function(u){var b=ee(j[u].q);return!b||!n.has(b)});s<0&&(s=0);var o=a.splice(s,1)[0],l=ee(j[o].q);i.push(o),l&&n.add(l)}return i}function Xe(e,n){var a=n||e.length,i=(t.endless.recentSimilarityTags||[]).slice(-6),s=new Set(t.settings.endlessFastMode?t.endless.fastSeenSimilarityTags||[]:[]);if(t.settings.endlessDiffs&&t.settings.endlessDiffs.length){for(var o=[];o.length<a&&e.length;){var l=rt(da(e),i);if(t.settings.endlessFastMode&&(l=pa(l,s)),o.length&&l.length>1&&o[o.length-1]===l[0]){var u=l[0];l[0]=l[1],l[1]=u}o=o.concat(l)}return rt(o.slice(0,a),i)}if(e.length<2)return e.slice();for(var b=[],f=0;f<a;f++){for(var y=0,g=e.map(function(x){var m=ua(j[x]);b.length&&x===b[b.length-1]&&(m*=.08);var A=ee(j[x].q);return A&&i.indexOf(A)!==-1&&(m*=.025),t.settings.endlessFastMode&&A&&s.has(A)&&(m*=.002),y+=m,{i:x,ceiling:y}}),P=Math.random()*y,E=g[g.length-1].i,_=0;_<g.length;_++)if(P<g[_].ceiling){E=g[_].i;break}b.push(E);var p=ee(j[E].q);p&&(i.push(p),i=i.slice(-6),s.add(p))}return b}function bt(e){var n=ee(e);n&&(t.endless.recentSimilarityTags||(t.endless.recentSimilarityTags=[]),t.endless.recentSimilarityTags.push(n),t.endless.recentSimilarityTags=t.endless.recentSimilarityTags.slice(-6),t.settings.endlessFastMode&&(t.endless.fastSeenSimilarityTags||(t.endless.fastSeenSimilarityTags=[]),t.endless.fastSeenSimilarityTags.indexOf(n)===-1&&t.endless.fastSeenSimilarityTags.push(n)))}function ze(){var e=t.settings.endlessUnits,n=t.settings.endlessDiffs,a=t.settings.endlessTiers,i;return!e||e.length===0?i=j.map(function(s,o){return o}):(i=[],e.forEach(function(s){i=i.concat(Ge[s]||[])})),n&&n.length&&(i=i.filter(function(s){return n.indexOf(j[s].diff)!==-1})),a&&a.length&&(i=i.filter(function(s){return a.indexOf(j[s].tier)!==-1})),i}function Ze(){t.endless.fastSeenSimilarityTags=[],t.endless.queue=Xe(ze(),t.settings.endlessBatchSize),t.endless.pos=0,t.endless.sessionCorrect=0,t.endless.sessionWrong=0}function Je(){var e=t.settings.endlessBatchSize||ze().length;(t.endless.queue.length!==e||t.endless.pos>=t.endless.queue.length)&&Ze()}function $e(){t.endless.fastSeenSimilarityTags=[];var e=t.endless.queue.length?t.endless.queue[t.endless.queue.length-1]:-1,n=Xe(ze(),t.settings.endlessBatchSize);if(n.length>1&&n[0]===e){var a=n[0];n[0]=n[1],n[1]=a}t.endless.queue=n,t.endless.pos=0,t.endless.sessionCorrect=0,t.endless.sessionWrong=0}function mt(e){var n=Xe(ze());if(n.length>1&&n[0]===e){var a=n.findIndex(function(s){return s!==e});if(a>0){var i=n[0];n[0]=n[a],n[a]=i}}t.endless.queue=n,t.endless.pos=0}function gt(e){var n=t.endless.queue.length-t.endless.pos;if(!(n<=0)){var a=Xe(ze(),n);if(a.length>1&&a[0]===e){var i=a.findIndex(function(o){return o!==e});if(i>0){var s=a[0];a[0]=a[i],a[i]=s}}t.endless.queue=t.endless.queue.slice(0,t.endless.pos).concat(a)}}var r={curQ:null,screen:"map",stageIndex:0,order:[],qIndex:0,heroHP:100,monsterHP:100,wrong:0,locked:!1,failReason:null,lessonFromBattle:!1,activeQs:[],pickerSelection:[],pickerDiffSelection:[1,2,3,4],pickerTierSelection:[1,2,3,4,5],pickerBatchSize:0,pickerFastMode:!0,pickerReturnScreen:"map",pickerReturnFocusId:null,reviewQueue:[],reviewPos:0,reviewStats:{correct:0,wrong:0},dragPlacement:{},dragSelected:null,dragQid:null,mobileLineOrder:[],mobileLineSelected:null,mobileLineQid:null,startTier:1,studyStep:0,studyPicked:null,studyCombo:0,studyBestCombo:0,studyWrongCount:0};function en(e){for(var n=e.slice(),a=n.length-1;a>0;a--){var i=Math.floor(Math.random()*(a+1)),s=n[a];n[a]=n[i],n[i]=s}return n}function Se(e){for(var n="",a=0;a<3;a++)n+=a<e?"★":"☆";return n}function z(){var e=0;return Object.keys(t.stars).forEach(function(n){e+=t.stars[n]}),e}function d(e){return String(e).replace(/[&<>"']/g,function(n){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[n]})}var fa={"＊":"*","＋":"+","－":"-","＜":"<","＞":">","／":"/","＆":"&","（":"(","）":")","：":":","；":";","＿":"_","．":".","，":",","　":" ","％":"%","＝":"=","！":"!","”":'"',"“":'"',"’":"'","‘":"'","〜":"~","～":"~","｛":"{","｝":"}","［":"[","］":"]","＃":"#","｜":"|","？":"?","＠":"@","＾":"^","￥":"\\","−":"-"};function ba(e){var n=String(e);return typeof n.normalize=="function"&&(n=n.normalize("NFKC")),n.replace(/[Ａ-Ｚａ-ｚ０-９]/g,function(a){return String.fromCharCode(a.charCodeAt(0)-65248)}).replace(/[＊＋－＜＞／＆（）：；＿．，　％＝！”“’‘〜～｛｝［］＃｜？＠＾￥−]/g,function(a){return fa[a]})}function ma(e){return String(e).trim().replace(/^```[a-zA-Z0-9_+-]*\s*/,"").replace(/\s*```$/,"")}function it(e){return ba(ma(e)).replace(/[\u200B-\u200D\uFEFF]/g,"").trim().toLowerCase().replace(/\s+/g,"")}function st(e){return e.replace(/[;。、.]+$/,"")}function lt(e){return e.replace(/std::/g,"")}function ga(e,n){return!/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)||!/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(n)?!1:Number(e)===Number(n)}function nn(e,n){var a=it(e),i=st(a),s=lt(i);return n.some(function(o){var l=it(o),u=st(l),b=lt(u);return a===l||i===u||s===b||ga(i,u)})}var Rn={gold:3,silver:2,bronze:1};var vt={mark:'<path d="M12 2 20 6.5v9L12 20l-8-4.5v-9L12 2Z"/><path d="m9 8-3 4 3 4M15 8l3 4-3 4M13.5 6l-3 12"/>',book:'<path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H11v17H6.5A2.5 2.5 0 0 0 4 21.5v-17ZM20 4.5A2.5 2.5 0 0 0 17.5 2H13v17h4.5a2.5 2.5 0 0 1 2.5 2.5v-17Z"/>',sword:'<path d="m14.5 4.5 5-2-2 5L9 16l-3 1 1-3 7.5-9.5ZM13 6l5 5M4 17l3 3M3 21l4-4"/>',target:'<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3"/>',lock:'<rect x="5" y="10" width="14" height="11" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3M12 14v3"/>',unlock:'<rect x="5" y="10" width="14" height="11" rx="2"/><path d="M8 10V7a4 4 0 0 1 7.5-2M12 14v3"/>',archive:'<path d="M4 7h16v14H4zM3 3h18v4H3zM9 11h6"/>',review:'<path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><path d="M3 3v5h5M12 7v5l3 2"/>',chip:'<rect x="6" y="6" width="12" height="12" rx="2"/><path d="M9 9h6v6H9zM9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4"/>',shield:'<path d="M12 2 20 5v6c0 5-3.4 8.7-8 11-4.6-2.3-8-6-8-11V5l8-3Z"/><path d="m9 12 2 2 4-5"/>',enemy:'<path d="M5 9 3 4l5 2 4-3 4 3 5-2-2 5 1 4-3 7H7l-3-7 1-4Z"/><path d="M8 12h.01M16 12h.01M9 17l3-2 3 2"/>',trophy:'<path d="M8 3h8v5a4 4 0 0 1-8 0V3ZM8 5H4v2a4 4 0 0 0 4 4M16 5h4v2a4 4 0 0 1-4 4M12 12v5M8 21h8M9 17h6"/>',alert:'<path d="M12 3 2 21h20L12 3Z"/><path d="M12 9v5M12 18h.01"/>',check:'<circle cx="12" cy="12" r="9"/><path d="m8 12 3 3 5-6"/>',menu:'<path d="M4 7h16M4 12h16M4 17h16"/>',spark:'<path d="m12 2 1.7 6.3L20 10l-6.3 1.7L12 18l-1.7-6.3L4 10l6.3-1.7L12 2Z"/>',terminal:'<path d="m5 7 4 4-4 4M11 16h8"/><rect x="2" y="3" width="20" height="18" rx="2"/>',node:'<circle cx="6" cy="12" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="18" cy="18" r="3"/><path d="m9 11 6-4M9 13l6 4"/>',search:'<circle cx="10.5" cy="10.5" r="6.5"/><path d="m15.5 15.5 5 5M8 10h5M10.5 7.5v5"/>'};function w(e,n){return'<svg class="uiicon'+(n?" "+n:"")+'" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">'+(vt[e]||vt.mark)+"</svg>"}function ie(e,n){if(n)return w("enemy","stageglyph");var a=["terminal","node","chip","archive","book","node","sword","lock","review","node","enemy","terminal","chip"],i=parseInt(String(e).replace(/\D/g,""),10);return Number.isFinite(i)||(i=String(e).charCodeAt(String(e).length-1)),w(a[Math.abs(i)%a.length],"stageglyph")}var ht=!1;function yt(e){if(!e||e.nodeType!==1)return!1;var n=e.tagName;return n==="INPUT"||n==="TEXTAREA"||n==="SELECT"?!e.disabled&&!e.readOnly:!!e.isContentEditable}function va(e){return!!(e&&e.closest&&e.closest("dialog[open], [data-escape-surface]"))}function ha(){var e=Array.prototype.slice.call(document.querySelectorAll(".codex-overlay, .modal, .popup, .overlay, dialog[open]"));if(e.length){var n=e[e.length-1];return n&&n.tagName==="DIALOG"&&n.hasAttribute("open")?typeof n.close=="function"&&n.close():n&&n.remove(),!0}var a=document.querySelectorAll("dialog[open]");if(a.length){var i=a[a.length-1],s=new Event("cancel",{cancelable:!0});return i.dispatchEvent(s)&&i.close(),!0}var o=document.querySelectorAll("[data-escape-dismiss]:not([hidden])");if(o.length)return o[o.length-1].click(),!0;var l=document.querySelectorAll("details[open]");if(l.length){var u=l[l.length-1];u.open=!1;var b=u.querySelector("summary");return b&&b.focus(),!0}if(r.screen==="unitPicker")return rn(),!0;var f=document.getElementById("btnHome")||document.getElementById("btnStudyBack")||document.getElementById("btnLessonBack");if(f&&f.offsetParent!==null)return f.click(),!0;var y=document.getElementById("btnMap");return y&&y.offsetParent!==null?(y.click(),!0):!1}function ya(){var e=document.getElementById("btnContinue")||document.getElementById("btnStudyNext")||document.getElementById("btnStudyToChallenge")||document.getElementById("btnToBattle");if(e&&!e.disabled)return e.click(),!0;var n=document.getElementById("btnNext");if(n&&!n.disabled)return n.click(),!0;var a=document.getElementById("btnReviewAgain");if(a&&!a.disabled)return a.click(),!0;var i=document.getElementById("btnSubmit");return i&&!i.disabled&&!r.locked?(i.click(),!0):!1}function xa(e){var n=e.key||"",a=e.keyCode||e.which||0;if(n==="Enter"||a===13){if(e.isComposing||e.altKey||e.ctrlKey||e.metaKey||e.shiftKey||yt(e.target))return;ya()&&(e.preventDefault(),e.stopPropagation());return}if(!(n!=="Escape"&&n!=="Esc"&&a!==27)&&!(e.defaultPrevented||e.isComposing||e.altKey||e.ctrlKey||e.metaKey)){if(yt(e.target)&&va(e.target)){e.target.blur(),e.preventDefault();return}ha()&&(e.preventDefault(),e.stopPropagation())}}function Ve(){ht||typeof document>"u"||(document.addEventListener("keydown",xa,!0),ht=!0)}typeof document<"u"&&Ve();function tn(){var e=D[r.stageIndex],n=e.lesson.map(function(u,b){return'<div class="frame lessoncard"><div class="lstep">例題 '+(b+1)+" / "+e.lesson.length+"</div><h3>"+d(u.title)+'</h3><pre class="codeblock">'+d(u.code)+'</pre><p class="lessonexplain">'+d(u.explain)+"</p></div>"}).join(""),a=r.lessonFromBattle?"← 戦闘へ戻る":"← 地図へ戻る",i=r.lessonFromBattle?"":'<button class="togglebtn" id="btnLessonToggleStudy">⇄ 学習パートに切替</button>',s;if(r.lessonFromBattle)s='<div class="actionrow"><button class="primary" id="btnToBattle">戦いに戻る →</button></div>';else{var o=[1,2,3,4].map(function(u){return Bt(e,u).length}),l=[1,2,3,4].map(function(u){return'<button class="diffbtn" data-tier="'+u+'"><span class="dname">'+d(N[u])+'</span><span class="ddesc">からスタート(残り'+o[u-1]+"問)</span></button>"}).join("");s='<div class="frame diffpick"><div class="difftitle">'+w("sword")+" 難易度を選んで"+d(e.mon)+'に挑もう</div><p class="ddesc" style="margin:0 0 14px;">選んだ難易度の設問からランダムに出題が始まり、探偵が捜査を続けられるかぎり、そのグループを出し切るごとに1つ上の難易度へ自動でエスカレートしていく。高い難易度から始めるほど、序盤から手強い相手になる。</p><div class="diffrow">'+l+"</div></div>"}return""+U()+'<div class="battlebar"><button class="backbtn" id="btnLessonBack">'+a+"</button>"+i+'</div><div class="frame lessonintro"><h2>'+ie(e.id,e.isBoss)+" 訓練場 — "+d(e.title)+"</h2><p>"+d(e.sub)+"の要点を、完成した正しいコードと解説で確認しよう。まずは読んで感覚をつかんでから、"+d(e.mon)+'に挑むと理解しやすい。</p></div><div class="lessongrid">'+n+"</div>"+s}function an(e){document.getElementById("btnLessonBack").addEventListener("click",function(){r.screen=r.lessonFromBattle?"battle":"map",C()});var n=document.getElementById("btnLessonToggleStudy");n&&n.addEventListener("click",function(){r.screen="study",C()});var a=document.getElementById("btnToBattle");a&&a.addEventListener("click",function(){r.screen="battle",C()}),Array.prototype.forEach.call(e.querySelectorAll(".diffbtn"),function(i){i.addEventListener("click",function(){ye(r.stageIndex,parseInt(i.getAttribute("data-tier"),10))})})}function Bt(e,n){for(var a=(e.qs||[]).concat(e.qsHard||[]).concat(e.qsExtra||[]).concat(e.qsDrag||[]).concat(e.qsExpert||[]).filter(function(b){return!Ye(b)}),i=n||1,s=a.filter(function(b){return(b.diff||1)>=i}).map(function(b){var f=Math.max(i,Mn(b.unit||e.id)),y=100+(f-1)*300;return{q:b,distance:Math.abs(In(b)-y),tie:Math.random()}}).sort(function(b,f){return b.distance-f.distance||b.tie-f.tie}),o=[];s.length;){var l=o.slice(-6).map(ee),u=s.findIndex(function(b){var f=ee(b.q);return!f||l.indexOf(f)===-1});u<0&&(u=0),o.push(s.splice(u,1)[0].q)}return o}function ye(e,n){var a=D[e];r.startTier=n||1,r.activeQs=Bt(a,r.startTier),r.screen="battle",r.stageIndex=e,r.order=r.activeQs.map(function(i,s){return s}),r.qIndex=0,r.heroHP=100,r.monsterHP=100,r.wrong=0,r.locked=!1,r.failReason=null,C()}function fe(){r.pickerReturnScreen=r.screen||"map";var e=document.activeElement;r.pickerReturnFocusId=e&&e.id?e.id:null;var n=t.settings.endlessUnits,a=t.settings.endlessDiffs,i=t.settings.endlessTiers;r.pickerSelection=n&&n.length?n.slice():Q.map(function(s){return s.id}),r.pickerDiffSelection=a&&a.length?a.slice():[1,2,3,4],r.pickerTierSelection=i&&i.length?i.slice():[1,2,3,4,5],r.pickerBatchSize=t.settings.endlessBatchSize,r.pickerFastMode=t.settings.endlessFastMode!==!1,r.screen="unitPicker",C()}function rn(){var e=r.pickerReturnScreen||"map",n=r.pickerReturnFocusId;r.screen=e,r.pickerReturnScreen="map",r.pickerReturnFocusId=null,C(),n&&requestAnimationFrame(function(){var a=document.getElementById(n);a&&a.focus()})}function sn(){var e=r.pickerSelection,n=r.pickerDiffSelection,a=r.pickerTierSelection,i=r.pickerBatchSize,s=r.pickerFastMode,o=Q.map(function(g){var P=e.indexOf(g.id)!==-1,E=Ke(g.id),_=E.wrongRate===null?null:Math.round(E.wrongRate*100);return'<button class="unitchip'+(P?" on":"")+'" data-unit="'+g.id+'"><span class="uc-emoji">'+ie(g.id,!1)+'</span><span class="uc-case">'+d(g.title)+'</span><span class="uc-title">'+d(g.sub)+'</span><span class="uc-rate">'+(_===null?"未挑戦":"誤答率"+_+"%")+"</span></button>"}).join(""),l=[1,2,3,4].map(function(g){var P=n.indexOf(g)!==-1;return'<button class="diffchip'+(P?" on":"")+'" data-diff="'+g+'">'+d(N[g])+"</button>"}).join(""),u=[1,2,3,4,5].map(function(g){var P=a.indexOf(g)!==-1,E=j.filter(function(_){return _.tier===g}).length;return'<button class="tierchip t'+g+(P?" on":"")+'" data-tier="'+g+'"><span class="tc-label">'+d(ae[g])+'</span><span class="tc-count">'+E+'問</span><span class="tc-desc">'+d(nt[g])+"</span></button>"}).join(""),b=[0,10,20,50,100].map(function(g){return'<button class="diffchip'+(i===g?" on":"")+'" data-batch-size="'+g+'">'+(g===0?"制限なし":g+"問")+"</button>"}).join(""),f=W(e),y=r.pickerReturnScreen==="endless"?"← 問題へ戻る":"← 地図へ戻る";return""+U()+'<div class="battlebar"><button class="backbtn" id="btnPickerBack" data-escape-dismiss>'+y+'</button></div><div class="frame intro"><h2>'+w("target")+' 出題する単元・難易度・重要度を選ぶ</h2><p>チェックした単元・難易度・重要度だけを対象に1000本ノックを出題します。誤答率が高い単元には目印がついているので、絞り込みの参考にしよう。何も選ばなければ開始できません。</p></div><div class="frame recobar cramcard"><div class="reco-text">'+w("spark")+' 時間がないなら「鉄板」と「頻出」だけに絞って、全単元をひと通り最短で回そう。</div><button class="primary" id="btnPickerCram">'+w("spark")+' 一夜漬けモード（鉄板・頻出のみ）→</button></div><div class="frame recobar"><div class="reco-text">'+w("target")+' <b>快速モード</b>：似た問題はなるべく1問に絞り、違う内容をテンポよく出題します。<span class="reco-sub">難易度のユーザー指定には含まれず、内部レートの自動調整は毎問そのまま動きます。</span></div><button type="button" class="ghost" id="btnPickerFast" aria-pressed="'+(s?"true":"false")+'">快速モード：'+(s?"ON":"OFF")+'</button></div><div class="frame recobar"><div class="reco-text">'+w("chip")+" 選択中の単元でのおすすめ難易度: <b>"+d(N[f])+'</b><span class="reco-sub">(正答実績から自動判定。データが少ない単元はまず初級から勧めます)</span></div><button class="ghost" id="btnPickerAuto">'+w("target")+' 苦手分野+おすすめ難易度に自動設定</button></div><div class="actionrow" style="justify-content:flex-start; margin-bottom:14px;"><button class="ghost" id="btnPickerAll">単元を全選択</button><button class="ghost" id="btnPickerNone">単元を全解除</button></div><div class="unitgrid">'+o+'</div><div class="difftitle" style="margin-top:24px;">重要度で絞る(複数選択可) — 試験に出そうな核心から優先したいときに</div><div class="tierchiprow">'+u+'</div><div class="difftitle" style="margin-top:24px;">難易度で絞る(複数選択可)</div><div class="diffchiprow">'+l+'</div><div class="difftitle" style="margin-top:24px;">1セットの出題数</div><div class="diffchiprow" role="radiogroup" aria-label="出題数">'+b+'</div><div class="actionrow" style="margin-top:20px;"><button class="primary" id="btnPickerStart"'+(e.length===0||n.length===0||a.length===0?" disabled":"")+">この設定で1000本ノックを開始 →</button></div>"}function ln(e){document.getElementById("btnPickerBack").addEventListener("click",function(){rn()}),Array.prototype.forEach.call(e.querySelectorAll(".unitchip"),function(n){n.addEventListener("click",function(){var a=n.getAttribute("data-unit"),i=r.pickerSelection.indexOf(a);i===-1?r.pickerSelection.push(a):r.pickerSelection.splice(i,1),C()})}),document.getElementById("btnPickerAll").addEventListener("click",function(){r.pickerSelection=Q.map(function(n){return n.id}),C()}),document.getElementById("btnPickerNone").addEventListener("click",function(){r.pickerSelection=[],C()}),Array.prototype.forEach.call(e.querySelectorAll("[data-diff]"),function(n){n.addEventListener("click",function(){var a=parseInt(n.getAttribute("data-diff"),10),i=r.pickerDiffSelection.indexOf(a);i===-1?r.pickerDiffSelection.push(a):r.pickerDiffSelection.splice(i,1),C()})}),Array.prototype.forEach.call(e.querySelectorAll(".tierchip"),function(n){n.addEventListener("click",function(){var a=parseInt(n.getAttribute("data-tier"),10),i=r.pickerTierSelection.indexOf(a);i===-1?r.pickerTierSelection.push(a):r.pickerTierSelection.splice(i,1),C()})}),Array.prototype.forEach.call(e.querySelectorAll("[data-batch-size]"),function(n){n.addEventListener("click",function(){r.pickerBatchSize=parseInt(n.getAttribute("data-batch-size"),10),C()})}),document.getElementById("btnPickerAuto").addEventListener("click",function(){var n=ft();r.pickerSelection=n.slice(),r.pickerDiffSelection=[W(n)],C()}),document.getElementById("btnPickerFast").addEventListener("click",function(){r.pickerFastMode=!r.pickerFastMode,t.settings.endlessFastMode=r.pickerFastMode,H(t),C()}),document.getElementById("btnPickerCram").addEventListener("click",function(){r.pickerSelection=Q.map(function(n){return n.id}),r.pickerDiffSelection=[1,2,3,4],r.pickerTierSelection=[1,2],t.settings.endlessUnits=null,t.settings.endlessDiffs=null,t.settings.endlessTiers=[1,2],t.settings.endlessBatchSize=r.pickerBatchSize,t.settings.endlessFastMode=r.pickerFastMode,H(t),Ze(),r.curQ=null,r.screen="endless",C()}),document.getElementById("btnPickerStart").addEventListener("click",function(){r.pickerSelection.length===0||r.pickerDiffSelection.length===0||r.pickerTierSelection.length===0||(t.settings.endlessUnits=r.pickerSelection.length===Q.length?null:r.pickerSelection.slice(),t.settings.endlessDiffs=r.pickerDiffSelection.length===4?null:r.pickerDiffSelection.slice(),t.settings.endlessTiers=r.pickerTierSelection.length===5?null:r.pickerTierSelection.slice(),t.settings.endlessBatchSize=r.pickerBatchSize,t.settings.endlessFastMode=r.pickerFastMode,H(t),Ze(),r.curQ=null,r.screen="endless",C())})}function wa(){var e=t.endless.queue[t.endless.pos];return j[e]}function ka(){var e=r.order[r.qIndex];return r.activeQs[e]}var _a={fill:'空欄(<span style="color:var(--accent);font-weight:700;">______</span>)に入るコードや単語を実際に入力して、呪文のように唱えよう。',debug:"🐛 このコードには誤りが1箇所ある。正しく直した内容を入力して唱えよう。",choice:"次のうち正しいものを選んで唱えよう。",order:"A〜Dなどのカードをドラッグして、正しい順番に並べよう。",dragfill:"下のピースをドラッグ（またはタップで選んで配置）して、空欄をすべて埋めよう。"};function Ba(){return!!t.settings.mobileAnswerMode}function Aa(e){return'<div class="answer-mode" role="group" aria-label="回答方法"><span class="answer-mode-label">回答方法</span><button type="button" class="answer-mode-btn'+(e?"":" active")+'" data-answer-mode="input" aria-pressed="'+!e+'">⌨ 入力</button><span class="answer-mode-arrow" aria-hidden="true">→</span><button type="button" class="answer-mode-btn'+(e?" active":"")+'" data-answer-mode="selection" aria-pressed="'+e+'">☝ 選択</button></div>'}function xt(e,n,a,i){return'<button type="button" class="choicebtn answer-choice '+(a||"")+'" '+(i||"")+'><span class="choice-index" aria-hidden="true">'+String.fromCharCode(65+n)+'</span><span class="choice-text">'+d(e)+"</span></button>"}function Ca(e){return e.long?'<div class="answerrow long"><textarea class="codeinput long" id="ansInput" rows="6" autocomplete="off" autocapitalize="off" autocorrect="off" spellcheck="false" placeholder="答えを入力…（複数行も入力できます）"></textarea></div><div class="actionrow"><button class="primary" id="btnSubmit">入力した答えで回答 →</button></div>':'<div class="answerrow"><input class="codeinput" id="ansInput" type="text" autocomplete="off" autocapitalize="off" autocorrect="off" spellcheck="false" placeholder="答えを入力…"><button class="primary" id="btnSubmit">入力した答えで回答 →</button></div>'}function wt(e){var n=String(e);return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(n.trim())?"number":/^[!<>=+\-*/%&|^~]+$/.test(n.trim())?"operator":/^[A-Za-z_][\w:]*$/.test(n.trim())?"word":/[{}();<>=]|\n/.test(n)?"code":"text"}function At(e){var n=e.answers[0],a=wt(n),i=[];j.forEach(function(b){var f=b.q,y=f.type||"fill";if(!(f.qid===e.qid||f.long||y!=="fill"&&y!=="debug"||f.unit!==e.unit)){var g=f.answers&&f.answers[0];g&&wt(g)===a&&!nn(g,e.answers)&&i.push(g)}});var s=[];i.sort(function(b,f){return Math.abs(String(b).length-String(n).length)-Math.abs(String(f).length-String(n).length)}),i.forEach(function(b){s.indexOf(b)===-1&&s.length<3&&s.push(b)});var o=a==="number"?["0","1","2","10"]:a==="operator"?["==","!=","<",">","<=",">="]:a==="word"?["cout","cin","int","string","return","endl"]:["エラー","できる","できない","正しい"];o.forEach(function(b){s.length<3&&!nn(b,e.answers)&&s.indexOf(b)===-1&&s.push(b)});var l=[n].concat(s.slice(0,3)),u=String(e.qid||"").split("").reduce(function(b,f){return b+f.charCodeAt(0)},0)%l.length;return l.slice(u).concat(l.slice(0,u))}function kt(e){var n=String(e.answers[0]).split(`
`).filter(function(o){return o.trim()!==""});if(n.length<2)return null;r.mobileLineQid!==e.qid&&(r.mobileLineQid=e.qid,r.mobileLineOrder=new Array(n.length).fill(null),r.mobileLineSelected=null);var a=r.mobileLineOrder,i=n.map(function(o,l){return{line:o,index:l}}).sort(function(o,l){var u=(String(e.qid)+o.index).split("").reduce(function(f,y){return f+y.charCodeAt(0)},0)%17,b=(String(e.qid)+l.index).split("").reduce(function(f,y){return f+y.charCodeAt(0)},0)%17;return u-b||l.index-o.index}).map(function(o){var l=a.indexOf(o.index)!==-1,u=r.mobileLineSelected===o.index;return'<button type="button" class="mobile-code-line'+(l?" used":"")+(u?" selected":"")+'" data-mobile-line="'+o.index+'" draggable="'+(l?"false":"true")+'"'+(l?" disabled":"")+"><code>"+d(o.line)+"</code></button>"}).join(""),s=a.map(function(o,l){return'<div class="mobile-code-slot'+(o!==null?" filled":"")+'" data-mobile-slot="'+l+'"><span>'+(l+1)+"</span>"+(o!==null?'<button type="button" class="mobile-code-placed" data-mobile-move="'+l+'" draggable="true"><code>'+d(n[o])+"</code></button>":'<button type="button" class="mobile-code-placeholder">選択またはドラッグして配置</button>')+"</div>"}).join("");return'<div class="mobile-code-builder"><p>コード行を選び、番号欄へドラッグ（タップ配置も可）</p><div class="mobile-code-source">'+i+'</div><div class="mobile-code-answer">'+s+'</div><div class="actionrow"><button class="ghost" id="btnMobileLineReset" type="button">リセット</button><button class="primary" id="btnMobileLineSubmit" type="button"'+(a.every(function(o){return o!==null})?"":" disabled")+">このコードで回答 →</button></div></div>"}function Ee(e){var n=e.type||"fill",a=Ba(),i=e.lead;n==="order"&&i&&(i=i.replace(/正しい順番を記号で答えなさい。?/,"カードを正しい順番に並べなさい。"));var s=i?d(i):_a[n];(n==="dragfill"||n==="order")&&r.dragQid!==e.qid&&(r.dragPlacement={},r.dragSelected=null,r.dragQid=e.qid);var o;if(n==="order"&&!a)o='<div class="order-reference" aria-label="並べ替えるコード">'+e.lines.map(function(m){return"<div><b>"+d(m.label)+"</b><code>"+d(m.code)+"</code></div>"}).join("")+"</div>";else if(n==="order"){var l=Object.keys(r.dragPlacement).map(function(m){return r.dragPlacement[m]}).filter(Boolean),u=e.lines.map(function(m){var A=l.indexOf(m.label)!==-1,B=r.dragSelected===m.label;return'<button type="button" class="dragpiece orderpiece'+(A?" used":"")+(B?" selected":"")+'" data-piece="'+d(m.label)+'" draggable="'+(A?"false":"true")+'"'+(A?" disabled":"")+"><b>"+d(m.label)+"</b><code>"+d(m.code)+"</code></button>"}).join(""),b=e.lines.map(function(m,A){var B="order-"+A,M=r.dragPlacement[B],O=e.lines.filter(function(k){return k.label===M})[0];return'<div class="orderrow"><span class="ordernum">'+(A+1)+'</span><button type="button" class="dragslot orderslot'+(O?" filled":"")+'" data-blank="'+B+'">'+(O?"<b>"+d(O.label)+"</b><code>"+d(O.code)+"</code>":"ここへカードを置く")+"</button></div>"}).join("");o='<div class="orderbuilder"><div class="ordertray">'+u+'</div><div class="orderanswer" aria-label="並び替えた回答">'+b+"</div></div>"}else if(n==="choice")o=e.code?'<pre class="codeblock">'+d(e.code)+"</pre>":"";else if(n==="dragfill"){var f=r.dragPlacement,y=e.lines.map(function(m){if(m.blank===void 0)return d(m.code);var A=f[m.blank],B=A?e.pieces.filter(function(M){return M.id===A})[0]:null;return'<span class="dragslot'+(B?" filled":"")+'" data-blank="'+m.blank+'">'+(B?d(B.code):"ここにピースを置く")+"</span>"});o='<pre class="codeblock dragcode">'+y.join(`
`)+"</pre>"}else o='<pre class="codeblock">'+d(e.before)+'<mark class="blank">______</mark>'+d(e.after)+"</pre>";var g;if(n==="choice"&&a)g='<div class="choicegrid" id="choiceGrid">'+e.options.map(function(m,A){return xt(m,A,"",'data-opt="'+A+'"')}).join("")+"</div>";else if(n==="order"&&a){var P=e.lines.every(function(m,A){return!!r.dragPlacement["order-"+A]});g='<div class="actionrow"><button class="ghost" id="btnDragReset" type="button">並び順をリセット</button><button class="primary" id="btnSubmit"'+(P?"":" disabled")+">この順番で回答 →</button></div>"}else if(n==="dragfill"&&a){var E=Object.keys(r.dragPlacement).map(function(m){return r.dragPlacement[m]}).filter(Boolean),_=e.pieces.map(function(m){var A=E.indexOf(m.id)!==-1,B=r.dragSelected===m.id;return'<button class="dragpiece'+(A?" used":"")+(B?" selected":"")+'" data-piece="'+m.id+'" draggable="'+(A?"false":"true")+'"'+(A?" disabled":"")+">"+d(m.code)+"</button>"}).join(""),p=e.lines.filter(function(m){return m.blank!==void 0}).map(function(m){return m.blank}),x=p.every(function(m){return!!r.dragPlacement[m]});g='<div class="dragtray" id="dragTray">'+_+'</div><div class="actionrow"><button class="ghost" id="btnDragReset" type="button">やり直す</button><button class="primary" id="btnSubmit"'+(x?"":" disabled")+">詠唱する →</button></div>"}else(n==="fill"||n==="debug")&&a&&e.long&&kt(e)?g=kt(e):(n==="fill"||n==="debug")&&a?g='<div class="mobile-choicegrid">'+At(e).map(function(m,A){return xt(m,A,"mobile-answer-choice",'data-mobile-answer="'+A+'"')}).join("")+"</div>":g=Ca(e);return{qlead:s,bodyHtml:o,answerHtml:Aa(a)+g}}function on(){var e=D[r.stageIndex];r.curQ||(r.curQ=ka());var n=r.activeQs.length,a=Ee(r.curQ);return""+U()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button><button class="backbtn" id="btnReview">'+w("book")+' 訓練場で例題を見直す</button></div><div class="combatants"><div class="frame fighter"><div class="who"><span class="emoji">'+w("shield")+'</span><div class="name">コード探偵<small>DETECTIVE UNIT</small></div></div><div class="hpbar hero"><i style="transform:scaleX('+r.heroHP/100+')"></i></div><div class="hpnum"><span>HP</span><span class="num">'+r.heroHP+' / 100</span></div></div><div class="vs">VS</div><div class="frame fighter"><div class="who"><span class="emoji">'+ie(e.id,!0)+'</span><div class="name">'+d(e.mon)+"<small>"+d(e.sub)+'</small></div></div><div class="hpbar monster"><i style="transform:scaleX('+r.monsterHP/100+')"></i></div><div class="hpnum"><span>HP</span><span class="num">'+r.monsterHP+' / 100</span></div></div></div><div class="frame qcard" id="qcard"><div class="qmeta"><span>設問 '+(r.qIndex+1)+" / "+n+' <span class="tierbadge t'+re(r.curQ)+'">'+d(ae[re(r.curQ)])+"</span></span><span>"+d(e.title)+" ・ 今: "+d(N[r.curQ.diff]||"")+'</span></div><div class="qlead">'+a.qlead+"</div>"+a.bodyHtml+a.answerHtml+'</div><div id="feedbackSlot"></div>'}function cn(){if(!r.curQ){var e=wa();r.curQ=e.q,r.endlessSrc=e}var n=Ee(r.curQ),a=t.endless,i=a.correct+a.wrong,s=i>0?Math.round(a.correct/i*100):0,o=t.settings.endlessUnits,l=o&&o.length?"("+o.length+"/"+Q.length+"単元に絞り込み中)":"(全単元)";return""+U()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button><button class="backbtn" id="btnEndlessFilter">'+w("target")+" 単元を絞る "+d(l)+'</button><button class="backbtn pauseinvestigation" id="btnPauseEndless">'+w("lock")+' 捜査を中断する</button></div><div class="frame endlessbar"><div class="estat"><span class="elabel">出題元</span><span class="evalue">'+d(r.endlessSrc.srcTitle)+'</span></div><div class="estat"><span class="elabel">連続正解</span><span class="evalue">'+a.streak+"(最高"+a.bestStreak+')</span></div><div class="estat"><span class="elabel">通算正答率</span><span class="evalue">'+a.correct+" / "+i+"("+s+'%)</span></div><div class="estat"><span class="elabel">'+(t.settings.endlessBatchSize===0?"出題数":"今セットの残数")+'</span><span class="evalue">'+(t.settings.endlessBatchSize===0?"制限なし（毎問調整）":t.endless.queue.length-t.endless.pos+" / "+t.endless.queue.length)+'</span></div></div><div class="frame qcard" id="qcard"><div class="qmeta"><span>1000本ノック <span class="tierbadge t'+r.endlessSrc.tier+'">'+d(ae[r.endlessSrc.tier])+"</span></span><span>"+d(r.endlessSrc.srcSub)+'</span></div><div class="qlead">'+n.qlead+"</div>"+n.bodyHtml+n.answerHtml+'</div><div id="feedbackSlot"></div>'}function dn(){var e=t.endless.sessionCorrect||0,n=t.endless.sessionWrong||0,a=e+n,i=a?Math.round(e/a*100):0;return""+U()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button></div><div class="frame result achieve"><span class="bigemoji">'+w("target")+"</span><h2>"+a+"本ノック完了！</h2><p>正解 <b>"+e+"</b>問 ／ 誤答 <b>"+n+"</b>問 ／ 正答率 <b>"+i+'%</b></p><div class="resultbtns"><button class="primary" id="btnEndlessAgain">同じ設定でもう一度 →</button><button class="ghost" id="btnEndlessSettings">条件を変更する</button></div></div>'}function be(e){var n=r.curQ.type||"fill";Array.prototype.forEach.call(document.querySelectorAll("[data-answer-mode]"),function(l){l.addEventListener("click",function(){var u=l.getAttribute("data-answer-mode")==="selection";t.settings.mobileAnswerMode!==u&&(t.settings.mobileAnswerMode=u,H(t),C())})});var a=e.querySelectorAll(".mobile-answer-choice");if(a.length){var i=At(r.curQ);Array.prototype.forEach.call(a,function(l){l.addEventListener("click",function(){l.classList.add("chosen"),Array.prototype.forEach.call(a,function(u){u.disabled=!0}),je(i[parseInt(l.getAttribute("data-mobile-answer"),10)])})})}else if(document.getElementById("btnMobileLineSubmit"))Sa(e);else if(document.getElementById("ansInput")){var s=document.getElementById("ansInput"),o=document.getElementById("btnSubmit");o.addEventListener("click",_t),s.addEventListener("keydown",function(l){l.key!=="Enter"||r.locked||l.isComposing||s.tagName==="TEXTAREA"&&l.shiftKey||(l.preventDefault(),l.stopPropagation(),_t())}),s.focus()}else n==="choice"?Array.prototype.forEach.call(e.querySelectorAll(".choicebtn"),function(l){l.addEventListener("click",function(){Ha(parseInt(l.getAttribute("data-opt"),10))})}):(n==="dragfill"||n==="order")&&Pa(e)}function Sa(e){var n=!1;function a(s,o,l){l!==null&&(r.mobileLineOrder[l]=null);var u=r.mobileLineOrder.indexOf(s);u!==-1&&(r.mobileLineOrder[u]=null);var b=r.mobileLineOrder[o];r.mobileLineOrder[o]=s,b!==null&&l!==null&&(r.mobileLineOrder[l]=b),r.mobileLineSelected=null,C()}function i(s,o,l){s.addEventListener("pointerdown",function(u){if(u.pointerType==="mouse")return;n=!1;var b=u.clientX,f=u.clientY;s.setPointerCapture(u.pointerId),s.classList.add("touch-dragging");function y(P){Math.abs(P.clientX-b)+Math.abs(P.clientY-f)>8&&(n=!0)}function g(P){if(s.classList.remove("touch-dragging"),s.removeEventListener("pointermove",y),s.removeEventListener("pointerup",g),!!n){var E=document.elementFromPoint(P.clientX,P.clientY),_=E&&E.closest?E.closest("[data-mobile-slot]"):null;_&&a(o,parseInt(_.getAttribute("data-mobile-slot"),10),l)}}s.addEventListener("pointermove",y),s.addEventListener("pointerup",g)})}Array.prototype.forEach.call(e.querySelectorAll("[data-mobile-line]:not(:disabled)"),function(s){s.addEventListener("click",function(){if(n){n=!1;return}var o=parseInt(s.getAttribute("data-mobile-line"),10);r.mobileLineSelected=r.mobileLineSelected===o?null:o,C()}),s.addEventListener("dragstart",function(o){o.dataTransfer&&o.dataTransfer.setData("text/plain","line:"+s.getAttribute("data-mobile-line"))}),i(s,parseInt(s.getAttribute("data-mobile-line"),10),null)}),Array.prototype.forEach.call(e.querySelectorAll("[data-mobile-slot]"),function(s){var o=parseInt(s.getAttribute("data-mobile-slot"),10);s.addEventListener("dragover",function(l){l.preventDefault(),s.classList.add("dragover")}),s.addEventListener("dragleave",function(){s.classList.remove("dragover")}),s.addEventListener("drop",function(l){l.preventDefault();var u=(l.dataTransfer?l.dataTransfer.getData("text/plain"):"").split(":");if(u[0]==="line"&&a(parseInt(u[1],10),o,null),u[0]==="slot"){var b=parseInt(u[1],10);a(r.mobileLineOrder[b],o,b)}}),s.addEventListener("click",function(l){l.target.closest("[data-mobile-move]")||r.mobileLineSelected!==null&&a(r.mobileLineSelected,o,null)})}),Array.prototype.forEach.call(e.querySelectorAll("[data-mobile-move]"),function(s){var o=parseInt(s.getAttribute("data-mobile-move"),10),l=r.mobileLineOrder[o];s.addEventListener("click",function(){if(n){n=!1;return}r.mobileLineOrder[o]=null,r.mobileLineSelected=l,C()}),s.addEventListener("dragstart",function(u){u.dataTransfer&&u.dataTransfer.setData("text/plain","slot:"+o)}),i(s,l,o)}),document.getElementById("btnMobileLineReset").addEventListener("click",function(){r.mobileLineOrder=new Array(r.mobileLineOrder.length).fill(null),r.mobileLineSelected=null,C()}),document.getElementById("btnMobileLineSubmit").addEventListener("click",function(){var s=String(r.curQ.answers[0]).split(`
`).filter(function(o){return o.trim()!==""});je(r.mobileLineOrder.map(function(o){return s[o]}).join(`
`))})}function Ea(e){if((e.type||"fill")==="order")return e.lines.map(function(a,i){return r.dragPlacement["order-"+i]||""}).join(",");var n=e.lines.filter(function(a){return a.blank!==void 0}).map(function(a){return a.blank});return n.map(function(a){return a+"="+(r.dragPlacement[a]||"")}).join("|")}function Pa(e){Array.prototype.forEach.call(e.querySelectorAll(".dragpiece:not(.used)"),function(i){i.addEventListener("click",function(){if(!r.locked){var s=i.getAttribute("data-piece");r.dragSelected=r.dragSelected===s?null:s,C()}}),i.addEventListener("dragstart",function(s){s.dataTransfer&&s.dataTransfer.setData("text/plain",i.getAttribute("data-piece"))})}),Array.prototype.forEach.call(e.querySelectorAll(".dragslot"),function(i){i.addEventListener("click",function(){if(!r.locked){var s=i.getAttribute("data-blank");i.classList.contains("filled")?r.dragPlacement[s]=null:r.dragSelected&&(r.dragPlacement[s]=r.dragSelected,r.dragSelected=null),C()}}),i.addEventListener("dragover",function(s){s.preventDefault()}),i.addEventListener("drop",function(s){if(s.preventDefault(),!r.locked){var o=s.dataTransfer?s.dataTransfer.getData("text/plain"):null;o&&(r.dragPlacement[i.getAttribute("data-blank")]=o,r.dragSelected=null,C())}})});var n=document.getElementById("btnDragReset");n&&n.addEventListener("click",function(){r.locked||(r.dragPlacement={},r.dragSelected=null,C())});var a=document.getElementById("btnSubmit");a&&a.addEventListener("click",function(){r.locked||a.disabled||je(Ea(r.curQ))})}function je(e){r.locked=!0;var n=r.screen==="endless",a=r.screen==="review",i=t.settings.allowAlt&&r.curQ.altAnswers&&r.curQ.altAnswers.length?r.curQ.answers.concat(r.curQ.altAnswers):r.curQ.answers,s=nn(e,i),o=document.getElementById("feedbackSlot"),l=document.getElementById("qcard");if(dt(r.curQ.unit,s),ut(r.curQ.qid,s),n)bt(r.curQ),s?(t.endless.correct++,t.endless.sessionCorrect=(t.endless.sessionCorrect||0)+1,t.endless.streak++,t.endless.streak>t.endless.bestStreak&&(t.endless.bestStreak=t.endless.streak),l.classList.add("pulse")):(t.endless.wrong++,t.endless.sessionWrong=(t.endless.sessionWrong||0)+1,t.endless.streak=0,l.classList.add("shake")),H(t);else if(a)s?(r.reviewStats.correct++,Ae("reviewsCleared",1),l.classList.add("pulse")):(r.reviewStats.wrong++,l.classList.add("shake")),H(t);else{var u=et[r.curQ.diff]||10,b=$n[r.curQ.diff]||20;s?(r.monsterHP=Math.max(0,r.monsterHP-u),l.classList.add("pulse")):(r.wrong++,r.heroHP=Math.max(0,r.heroHP-b),l.classList.add("shake")),H(t)}var f,y;if(r.curQ.type==="dragfill"){var g=r.curQ.lines.filter(function(B){return B.blank!==void 0}).map(function(B){return B.blank}),P=function(B){var M=r.curQ.pieces.filter(function(O){return O.id===B})[0];return M?M.code:"(空欄)"};f='<div class="yourans"><span class="label">あなたの配置</span>'+g.map(function(B){return'<span class="chip">'+d(P(r.dragPlacement[B]))+"</span>"}).join("")+"</div>",y=s?"":'<div class="correctans"><span class="label">正解</span>'+g.map(function(B){return'<span class="chip">'+d(P(r.curQ.answerMap[B]))+"</span>"}).join("")+"</div>"}else if(f='<div class="yourans"><span class="label">あなたの回答</span><span class="chip">'+d(e)+"</span></div>",s){var E=i.some(function(B){return String(e).trim()===String(B).trim()});if(E)y="";else{var _=r.curQ.answers[0];y='<div class="correctans accepted-variant"><span class="label">教材の模範表記（どちらも正解）</span><button type="button" class="ghost-badge copyable" data-copy="'+d(_)+'">'+d(_)+"</button></div>"}}else{var p=r.curQ.altAnswers&&r.curQ.altAnswers.length?r.curQ.altAnswers:[],x=r.curQ.answers.map(function(B){return'<button type="button" class="ghost-badge copyable" data-copy="'+d(B)+'">'+d(B)+"</button>"}).join(""),m=p.map(function(B){return'<button type="button" class="ghost-badge copyable alt" data-copy="'+d(B)+'">'+d(B)+" <small>(別解)</small></button>"}).join("");y='<div class="correctans"><span class="label">正解例(クリックでコピー)</span>'+x+m+"</div>"}var A=!!t.missed[r.curQ.qid];o.innerHTML='<div class="frame feedback '+(s?"good":"bad")+'"><div class="head">'+w(s?"sword":"alert")+(s?" 会心の一撃！":" 手痛い反撃を受けた…")+"</div>"+f+y+'<div class="explain"><span class="tag">解説</span>'+d(r.curQ.explain)+'</div><label class="missedcheck"><input type="checkbox" id="missedToggle"'+(A?" checked":"")+"> "+w("review")+' この問題を復習ノートに入れる</label></div><div class="actionrow"><button class="primary" id="btnContinue">つづける →</button></div>',!n&&!a&&setTimeout(Da,30),Array.prototype.forEach.call(o.querySelectorAll(".copyable"),function(B){B.addEventListener("click",function(){var M=B.getAttribute("data-copy"),O=B.innerHTML;function k(){B.classList.add("copied"),B.innerHTML=w("check")+" コピーしました",setTimeout(function(){B.classList.remove("copied"),B.innerHTML=O},1200)}if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(M).then(k,k);else{var T=document.createElement("textarea");T.value=M,T.style.position="fixed",T.style.opacity="0",document.body.appendChild(T),T.select();try{document.execCommand("copy")}catch{}document.body.removeChild(T),k()}})}),document.getElementById("missedToggle").addEventListener("change",function(B){B.target.checked?t.missed[r.curQ.qid]=!0:delete t.missed[r.curQ.qid],H(t)}),document.getElementById("btnContinue").addEventListener("click",function(){if(r.curQ=null,n){var B=t.endless.queue[t.endless.pos];t.endless.pos++,t.settings.endlessBatchSize===0?mt(B):t.endless.pos>=t.endless.queue.length?r.screen="endless-result":(!t.settings.endlessDiffs||t.settings.endlessDiffs.length===0)&&gt(B),H(t),r.locked=!1,C();return}if(a){r.reviewPos++,r.locked=!1,C();return}if(r.heroHP<=0){r.failReason="hero",r.screen="result-lose",C();return}if(r.monsterHP<=0){r.screen="result-win",C();return}if(r.qIndex++,r.qIndex>=r.order.length){r.monsterHP<=0?r.screen="result-win":(r.failReason="outofq",r.screen="result-lose"),C();return}r.locked=!1,C()})}function Da(){var e=document.querySelector(".hpbar.hero i"),n=document.querySelector(".hpbar.monster i");e&&(e.style.transform="scaleX("+r.heroHP/100+")"),n&&(n.style.transform="scaleX("+r.monsterHP/100+")");var a=document.querySelectorAll(".hpnum .num");a[0]&&(a[0].textContent=r.heroHP+" / 100"),a[1]&&(a[1].textContent=r.monsterHP+" / 100")}function _t(){if(!r.locked){var e=document.getElementById("ansInput"),n=e.value;if(!n.trim()){e.classList.add("shake"),setTimeout(function(){e.classList.remove("shake")},350),e.focus();return}e.disabled=!0,document.getElementById("btnSubmit").disabled=!0,je(n)}}function Ha(e){if(!r.locked){var n=document.querySelector('.choicebtn[data-opt="'+e+'"]');n&&n.classList.add("chosen"),Array.prototype.forEach.call(document.querySelectorAll(".choicebtn"),function(a){a.disabled=!0}),je(r.curQ.options[e])}}var Pe=[{id:"overall",label:"総合進捗",unit:"pt"},{id:"dailyStreak",label:"連続捜査日数",unit:"日"},{id:"stars",label:"獲得スター",unit:"個"},{id:"clears",label:"クリア章",unit:"章"},{id:"correct",label:"累計正解",unit:"問"},{id:"accuracy",label:"正答率",unit:"%"},{id:"streak",label:"最高連続正解",unit:"問"},{id:"study",label:"学習完了",unit:"章"},{id:"medals",label:"学習メダル",unit:"pt"}];function Ia(e){for(var n=2166136261,a=0;a<e.length;a++)n^=e.charCodeAt(a),n=Math.imul(n,16777619);return n>>>0}function La(e){var n=e>>>0;return function(){n+=1831565813;var a=n;return a=Math.imul(a^a>>>15,a|1),a^=a+Math.imul(a^a>>>7,a|61),((a^a>>>14)>>>0)/4294967296}}function Ct(e){return(e||"id")+"-"+Date.now().toString(36)+"-"+Math.random().toString(36).slice(2,8)}function Ta(){for(var e="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",n="",a=0;a<6;a++)n+=e[Math.floor(Math.random()*e.length)];return n}function ne(){var e=!1;return t.ranking||(t.ranking={},e=!0),t.ranking.playerId||(t.ranking.playerId=Ct("player"),e=!0),t.ranking.nickname||(t.ranking.nickname="あなた",e=!0),Array.isArray(t.ranking.rooms)||(t.ranking.rooms=[],e=!0),t.ranking.activeMetric||(t.ranking.activeMetric="overall",e=!0),e&&H(t),t.ranking}function xe(){var e=ne();return{id:e.playerId,name:e.nickname}}function De(){var e=ne();return e.sharedIdentityId||e.playerId}function we(e){var n=ne();n.nickname=String(e||"").trim().slice(0,16)||"あなた",n.rooms.forEach(function(a){var i=a.members.filter(function(s){return s.id===n.playerId})[0];i&&(i.name=n.nickname)}),H(t)}function ce(){var e=z(),n=Object.keys(t.stars||{}).filter(function(y){return(t.stars[y]||0)>0}).length,a=0,i=0;Object.keys(t.unitStats||{}).forEach(function(y){a+=t.unitStats[y].correct||0,i+=t.unitStats[y].wrong||0});var s=a+i>0?Math.round(a/(a+i)*100):0,o=Object.keys(t.studyCompleted||{}).filter(function(y){return!!t.studyCompleted[y]}).length,l=0;Object.keys(t.studyMedal||{}).forEach(function(y){l+={gold:3,silver:2,bronze:1}[t.studyMedal[y]]||0});var u=t.endless&&t.endless.bestStreak||0,b=pe().streak||0,f=e*100+n*80+a*4+s*3+u*20+o*70+l*35;return{overall:f,dailyStreak:b,stars:e,clears:n,correct:a,accuracy:s,streak:u,study:o,medals:l,updatedAt:new Date().toISOString()}}var Ma=["NullHunter","Pointer侍","SegFault猫","ClassMaster","LoopRider","Bit探偵","Stack探偵","Lambda狐"];function Ra(e,n,a){var i=.35+e()*.9,s=Math.min(q,Math.max(0,Math.round((n.stars||10)*i+e()*8))),o=Math.min(D.length,Math.max(0,Math.round(s/2.5+e()*2))),l=Math.max(5,Math.round((n.correct||80)*i+e()*120)),u=Math.min(100,Math.max(42,Math.round((n.accuracy||72)+e()*24-10))),b=Math.max(1,Math.round((n.streak||5)*i+e()*12)),f=Math.max(1,Math.round((n.dailyStreak||3)*i+e()*7)),y=Math.min(D.length,Math.max(0,Math.round((n.study||4)*i+e()*5))),g=Math.min(D.length*3,Math.max(0,Math.round((n.medals||5)*i+e()*8)));return{overall:s*100+o*80+l*4+u*3+b*20+y*70+g*35,dailyStreak:f,stars:s,clears:o,correct:l,accuracy:u,streak:b,study:y,medals:g,updatedAt:new Date(Date.now()-a*36e5).toISOString()}}function St(e){var n=ne(),a=xe(),i={id:Ct("room"),code:Ta(),name:String(e||"").trim().slice(0,30)||"みんなの学習部屋",ownerId:a.id,createdAt:new Date().toISOString(),members:[{id:a.id,name:a.name,isPlayer:!0,snapshot:ce()}]},s=La(Ia(i.code));return Ma.forEach(function(o,l){i.members.push({id:"demo-"+i.id+"-"+l,name:o,isDemo:!0,snapshot:Ra(s,ce(),l+1)})}),n.rooms.unshift(i),n.activeRoomId=i.id,H(t),i}function Et(e){var n=ne(),a=String(e||"").trim().toUpperCase(),i=n.rooms.filter(function(s){return s.code===a})[0];return i?(n.activeRoomId=i.id,Oe(i.id),H(t),{ok:!0,room:i}):{ok:!1,error:"この端末には、その招待コードの部屋がありません。"}}function He(){return ne().rooms.slice()}function te(e){var n=ne();return n.rooms.filter(function(a){return a.id===(e||n.activeRoomId)})[0]||null}function Pt(e){var n=ne();return te(e)?(n.activeRoomId=e,Oe(e),H(t),!0):!1}function Oe(e){var n=te(e);if(n){var a=xe(),i=n.members.filter(function(s){return s.id===a.id})[0];!i&&n.isFirebase&&(i=n.members.filter(function(s){return!!s.isPlayer})[0]),i||(i={id:a.id,name:a.name,isPlayer:!0,snapshot:{}},n.members.push(i)),i.name=a.name,i.snapshot=ce(),H(t)}}function Dt(e){var n=ne();n.rooms=n.rooms.filter(function(a){return a.id!==e}),n.activeRoomId===e&&(n.activeRoomId=null),H(t)}function Fe(e){if(!e||!e.id)return null;var n=ne(),a=n.rooms.findIndex(function(i){return i.id===e.id});return e.isFirebase=!0,a===-1?n.rooms.unshift(e):n.rooms[a]=e,n.activeRoomId=e.id,H(t),e}function qn(e,n){var a=Pe.filter(function(i){return i.id===n})[0]||Pe[0];return(e?e.members:[]).map(function(i){return{id:i.id,name:i.name,isPlayer:i.isPlayer,isDemo:i.isDemo,value:Number((i.snapshot||{})[a.id])||0,updatedAt:(i.snapshot||{}).updatedAt}}).sort(function(i,s){return s.value!==i.value?s.value-i.value:String(i.updatedAt||"").localeCompare(String(s.updatedAt||""))}).map(function(i,s){return i.rank=s+1,i})}ne();var Ie={apiKey:"AIzaSyDFQqIU8RwD8hv1zh1_VE1IMQR7jGKCIXQ",authDomain:"code-case-bureau-2026.firebaseapp.com",projectId:"code-case-bureau-2026",storageBucket:"code-case-bureau-2026.firebasestorage.app",messagingSenderId:"89896901654",appId:"1:89896901654:web:26e93191d0ca4bbb7be937"},zn=!!(Ie.apiKey&&Ie.authDomain&&Ie.projectId&&Ie.appId);var Vn="12.16.0",un=null;function K(){return zn}async function X(){return zn?un||(un=Promise.all([import("https://www.gstatic.com/firebasejs/"+Vn+"/firebase-app.js"),import("https://www.gstatic.com/firebasejs/"+Vn+"/firebase-auth.js"),import("https://www.gstatic.com/firebasejs/"+Vn+"/firebase-firestore.js")]).then(async function(e){var n=e[0],a=e[1],i=e[2],s=n.initializeApp(Ie),o=a.getAuth(s);return o.currentUser||await a.signInAnonymously(o),{app:s,auth:o,db:i.getFirestore(s),firestore:i}}),un):null}function jn(e,n,a,i){return{clientId:String(i||"").slice(0,64),nickname:String(e||"あなた").slice(0,16),overall:n.overall||0,dailyStreak:n.dailyStreak||0,stars:n.stars||0,clears:n.clears||0,correct:n.correct||0,accuracy:n.accuracy||0,streak:n.streak||0,study:n.study||0,medals:n.medals||0,updatedAt:a()}}async function Ht(e,n){var a=await X();if(!a)return null;var i=a.firestore,s=a.auth.currentUser.uid,o=i.writeBatch(a.db),l=i.doc(a.db,"rooms",e.id),u=i.doc(a.db,"invites",e.code),b=i.doc(a.db,"rooms",e.id,"members",s);return o.set(l,{name:e.name,ownerId:s,code:e.code,createdAt:i.serverTimestamp()}),o.set(u,{roomId:e.id,ownerId:s,createdAt:i.serverTimestamp()}),o.set(b,jn(e.members[0].name,e.members[0].snapshot,i.serverTimestamp,n||e.members[0].id)),await o.commit(),e.id}async function On(e,n,a,i){var s=await X();if(!s)return null;var o=s.firestore,l=await o.getDoc(o.doc(s.db,"invites",String(e).toUpperCase()));if(!l.exists())throw new Error("招待コードが見つかりません。");var u=l.data().roomId;return await o.setDoc(o.doc(s.db,"rooms",u,"members",s.auth.currentUser.uid),jn(n,a,o.serverTimestamp,i),{merge:!0}),u}async function It(e,n,a,i){var s=await X();if(s){var o=s.firestore;await o.setDoc(o.doc(s.db,"rooms",e,"members",s.auth.currentUser.uid),jn(n,a,o.serverTimestamp,i),{merge:!0})}}async function pn(e){var n=await X();if(!n)return null;var a=n.firestore,i=await a.getDoc(a.doc(n.db,"rooms",e));if(!i.exists())return null;var s=await a.getDocs(a.collection(n.db,"rooms",e,"members"));return{id:e,code:i.data().code,name:i.data().name,ownerId:i.data().ownerId,members:Lt(s.docs.map(function(o){var l=o.data();return{id:o.id,clientId:l.clientId||"",name:l.nickname,isPlayer:o.id===n.auth.currentUser.uid,snapshot:l}}),n.auth.currentUser.uid)}}function Lt(e,n){var a={};return e.filter(function(i){if(!i.clientId)return!0;var s=a[i.clientId];if(!s)return a[i.clientId]=i,!0;if(i.id===n){var o=e.indexOf(s);return o!==-1&&(s.__duplicate=!0),a[i.clientId]=i,!0}return i.__duplicate=!0,!1}).filter(function(i){return!i.__duplicate})}async function Tt(e,n){var a=await X();a&&await a.firestore.deleteDoc(a.firestore.doc(a.db,"rooms",e,"members",n))}async function Mt(e,n,a){var i=await X();if(!i||!e)return function(){};var s=i.firestore;return s.onSnapshot(s.collection(i.db,"rooms",e.id,"members"),function(o){n({id:e.id,code:e.code,name:e.name,ownerId:e.ownerId,isFirebase:!0,members:Lt(o.docs.map(function(l){var u=l.data();return{id:l.id,clientId:u.clientId||"",name:u.nickname,isPlayer:l.id===i.auth.currentUser.uid,snapshot:u}}),i.auth.currentUser.uid)})},a||function(){})}function qa(){for(var e="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",n="",a=0;a<10;a++)n+=e[Math.floor(Math.random()*e.length)];return n}async function Rt(e){var n=await X();if(!n)return null;var a=n.firestore,i=n.auth.currentUser.uid,s=qa(),o=a.doc(a.collection(n.db,"syncProfiles")).id,l=a.writeBatch(n.db);return l.set(a.doc(n.db,"syncCodes",s),{syncId:o,ownerId:i,createdAt:a.serverTimestamp()}),l.set(a.doc(n.db,"syncProfiles",o),{ownerId:i,payload:e,revision:1,updatedAt:a.serverTimestamp()}),l.set(a.doc(n.db,"syncProfiles",o,"devices",i),{code:s,joinedAt:a.serverTimestamp()}),await l.commit(),{syncId:o,code:s}}async function qt(e){var n=await X();if(!n)return null;var a=n.firestore,i=String(e||"").trim().toUpperCase(),s=await a.getDoc(a.doc(n.db,"syncCodes",i));if(!s.exists())throw new Error("同期コードが見つかりません。");var o=s.data().syncId,l=n.auth.currentUser.uid;await a.setDoc(a.doc(n.db,"syncProfiles",o,"devices",l),{code:i,joinedAt:a.serverTimestamp()});var u=await a.getDoc(a.doc(n.db,"syncProfiles",o));if(!u.exists())throw new Error("同期データが見つかりません。");return{syncId:o,code:i,payload:u.data().payload||{},revision:u.data().revision||0}}async function zt(e,n,a){var i=await X();if(!(!i||!e)){var s=i.firestore;await s.setDoc(s.doc(i.db,"syncProfiles",e),{payload:n,revision:(a||0)+1,updatedAt:s.serverTimestamp()},{merge:!0})}}async function Vt(e,n,a){var i=await X();if(!i||!e)return function(){};var s=i.firestore;return s.onSnapshot(s.doc(i.db,"syncProfiles",e),function(o){o.exists()&&n(o.data())},a||function(){})}var fn=null,bn=null,jt=60*1e3,za=100,Va=100,ja=20,Ot=null,Ft=null,Nn=0,Ue=!1,gn="",Nt=null,Ne=null;function Un(){var e={};Object.keys(t).forEach(function(a){a!=="ranking"&&(e[a]=t[a])});var n=t.ranking||{};return e.rankingLinks={nickname:n.nickname||"あなた",identityId:n.sharedIdentityId||n.playerId||"",rooms:(Array.isArray(n.rooms)?n.rooms:[]).filter(function(a){return a.isFirebase&&a.code}).map(function(a){return{id:a.id,code:a.code,name:a.name}})},e.endless&&(e.endless=Object.assign({},e.endless,{queue:[],pos:0})),JSON.parse(JSON.stringify(e))}async function Qt(e){if(!(!K()||!e||!Array.isArray(e.rooms)))return Ne||(Ne=async function(){e.identityId&&(t.ranking.sharedIdentityId=String(e.identityId).slice(0,64)),e.nickname&&we(e.nickname);for(var n=0;n<e.rooms.length;n++){var a=e.rooms[n],i=He().some(function(l){return l.code===a.code});if(!i)try{var s=await On(a.code,xe().name,ce(),De()),o=await pn(s);o&&Fe(o)}catch(l){console.warn("同期済みランキング部屋への参加に失敗しました",a.code,l)}}}().finally(function(){Ne=null}),Ne)}function Ut(){var e=t.settings&&t.settings.progressSync;!K()||!e||Ue||(clearTimeout(Ot),Ot=setTimeout(async function(){var n=Qn("progressSyncs");if(!(n.count>=Va))try{var a=Un(),i=JSON.stringify(a);if(i===gn)return;await zt(e.syncId,a,Nn),gn=i,n.count++,H(t)}catch(s){console.warn("進捗同期に失敗しました",s)}},4e3))}async function Fn(){var e=t.settings&&t.settings.progressSync;!K()||!e||Ft||(Ft=await Vt(e.syncId,async function(n){if(Nn=n.revision||0,!!n.payload){var a=JSON.stringify(n.payload);if(a===JSON.stringify(Un())){gn=a;return}var i=n.payload.rankingLinks,s=JSON.parse(JSON.stringify(n.payload));delete s.rankingLinks,Ue=!0,Ln(s),await Qt(i),gn=a,Ue=!1,(r.screen==="map"||r.screen==="ranking"||r.screen==="ranking-room")&&C()}},function(n){console.warn("進捗リアルタイム同期を停止しました",n)}))}function Wt(){var e=ce();return delete e.updatedAt,e.identityId=De(),JSON.stringify(e)}function Yt(e){if(K()){var n=He().filter(function(i){return i.isFirebase});if(n.length){var a=Wt();t.ranking.remoteSnapshotKeys||(t.ranking.remoteSnapshotKeys={}),n.some(function(i){return t.ranking.remoteSnapshotKeys[i.id]!==a})&&(clearTimeout(Nt),Nt=setTimeout(function(){He().filter(function(i){return i.isFirebase}).forEach(function(i){Wn(i).catch(function(s){console.warn("ランキング同期に失敗しました",s)})})},typeof e=="number"?e:3e3))}}}typeof window<"u"&&(window.addEventListener("codecase:progress-saved",function(){Ut(),Yt()}),setTimeout(function(){Fn(),Ut()},0));function Qn(e){t.ranking.autoUpdateBudget||(t.ranking.autoUpdateBudget={});var n=new Date().toISOString().slice(0,10),a=t.ranking.autoUpdateBudget[e];return(!a||a.day!==n)&&(a={day:n,count:0}),t.ranking.autoUpdateBudget[e]=a,a}function mn(){bn&&bn(),bn=null,fn=null}async function Wn(e,n){if(!K()||!e)return!1;var a=Wt();if(t.ranking.remoteSnapshotKeys||(t.ranking.remoteSnapshotKeys={}),!n&&t.ranking.remoteSnapshotKeys[e.id]===a)return!1;t.ranking.remoteSyncAt||(t.ranking.remoteSyncAt={});var i=t.ranking.remoteSyncAt[e.id]||0;if(!n&&Date.now()-i<jt)return Yt(jt-(Date.now()-i)+100),!1;var s=Qn("syncs");return s.count>=za?!1:(await It(e.id,xe().name,ce(),De()),t.ranking.remoteSyncAt[e.id]=Date.now(),t.ranking.remoteSnapshotKeys[e.id]=a,s.count++,H(t),!0)}async function Oa(e){if(!(!K()||!e||fn===e.id)){mn();var n=Qn("listeners");if(!(n.count>=ja)){n.count++,H(t),fn=e.id;try{if(await Wn(e),fn!==e.id)return;bn=await Mt(e,function(a){Fe(a),r.screen==="ranking-room"&&te()&&te().id===a.id&&C()},function(a){console.warn("ランキング自動更新を停止しました",a)})}catch(a){console.warn("ランキング自動同期に失敗しました",a)}}}}function Gt(e){return Pe.filter(function(n){return n.id===e})[0]||Pe[0]}function Fa(){var e=He();return e.length?'<div class="room-list">'+e.map(function(n){var a=n.members.filter(function(i){return i.isPlayer})[0];return'<button class="room-card" data-room-id="'+d(n.id)+'"><span class="room-card-icon">'+w("trophy")+"</span><span><strong>"+d(n.name)+"</strong><small>"+n.members.length+"人 ・ 招待コード "+d(n.code)+"</small></span><b>"+(a?Math.round((a.snapshot||{}).overall||0).toLocaleString():"0")+" pt</b></button>"}).join("")+"</div>":'<div class="room-empty"><span>'+w("archive")+"</span><h3>まだ参加中の部屋はありません</h3><p>部屋を作成して、既存コンテンツの進捗を競ってみよう。</p></div>"}function Qe(){var e=xe(),n=ce();return""+U()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button></div><main class="league-shell"><section class="frame league-hero room-hero"><div><span class="league-eyebrow">PROGRESS RANKING ROOMS</span><h2>'+w("trophy")+' ランキングルーム</h2><p>新しい専用問題ではなく、これまでの章攻略・学習・演習の実績をみんなで競います。</p></div><label class="league-nickname room-profile">ランキング表示名<input id="rankingNickname" maxlength="16" value="'+d(e.name)+'"></label></section><section class="room-progress-strip"><div><small>総合進捗</small><strong>'+n.overall.toLocaleString()+" pt</strong></div><div><small>連続捜査</small><strong>"+n.dailyStreak+"日</strong></div><div><small>スター</small><strong>"+n.stars+"</strong></div><div><small>累計正解</small><strong>"+n.correct+"</strong></div><div><small>正答率</small><strong>"+n.accuracy+"%</strong></div><div><small>学習完了</small><strong>"+n.study+'章</strong></div></section><div class="room-actions-grid"><section class="frame room-action"><span class="league-eyebrow">CREATE ROOM</span><h3>新しい部屋を作る</h3><p>名前を決めると6文字の招待コードが発行されます。</p><form id="createRoomForm"><input id="roomName" maxlength="30" placeholder="例：期末試験ガチ勢"><button class="primary" type="submit">部屋を作成</button></form></section><section class="frame room-action"><span class="league-eyebrow">JOIN ROOM</span><h3>招待コードで参加</h3><p>友達から受け取った6文字のコードを入力します。</p><form id="joinRoomForm"><input id="roomCode" maxlength="6" placeholder="ABC234"><button class="primary" type="submit">部屋に参加</button></form><p class="room-error" id="roomError" aria-live="polite"></p></section></div><section class="frame room-index"><div class="room-section-head"><div><span class="league-eyebrow">DEVICE SYNC</span><h3>スマホ・PCの進捗同期</h3></div></div>'+(t.settings&&t.settings.progressSync?'<p>同期中のコード：<strong class="sync-code-value">'+d(t.settings.progressSync.code)+"</strong></p>":'<p>片方の端末でコードを発行し、もう片方へ入力すると同じ進捗を共有できます。</p><div class="room-actions-grid"><button class="primary" id="btnCreateProgressSync" type="button">同期コードを発行</button><form id="joinProgressSyncForm"><input id="progressSyncCode" maxlength="10" placeholder="10文字のコード"><button class="ghost" type="submit">この端末を同期</button></form></div>')+'<p class="room-error" id="progressSyncError" aria-live="polite"></p></section><section class="frame room-index"><div class="room-section-head"><div><span class="league-eyebrow">YOUR ROOMS</span><h3>参加中の部屋</h3></div><small>'+He().length+"部屋</small></div>"+Fa()+'</section><p class="league-local-note room-demo-note">'+(K()?"Firebaseオンライン同期が有効です。部屋コードを使って別端末から参加できます。":"ローカル動作確認モードです。Firebase設定を入力すると、同じ画面のまま別端末同期へ切り替わります。")+"</p></main>"}function Na(e){return'<div class="metric-tabs" role="tablist">'+Pe.map(function(n){return'<button role="tab" class="metric-tab'+(n.id===e?" active":"")+'" data-metric="'+n.id+'">'+d(n.label)+"</button>"}).join("")+"</div>"}function Ua(e,n){var a=Gt(n),i=e.members.some(function(s){return s.isPlayer&&s.id===e.ownerId});return'<div class="league-table room-ranking-table" role="table">'+qn(e,n).map(function(s){var o=s.id===e.ownerId;return'<div class="league-row'+(s.isPlayer?" player":"")+'" role="row"><span class="league-rank">'+s.rank+'</span><span class="league-name">'+d(s.name)+(o?' <small class="room-owner-badge">部屋主</small>':"")+(s.isPlayer?" <small>YOU</small>":"")+"</span><strong>"+s.value.toLocaleString()+" "+a.unit+'</strong><span class="member-kind">'+(o?"OWNER":s.isDemo?"DEMO":"MEMBER")+'</span><span class="member-action">'+(i&&!s.isPlayer?'<button type="button" data-kick-member="'+d(s.id)+'" data-kick-name="'+d(s.name)+'">キック</button>':"")+"</span></div>"}).join("")+"</div>"}function vn(){var e=te();if(!e)return r.screen="ranking",Qe();Oe(e.id);var n=t.ranking.activeMetric||"overall",a=qn(e,n),i=a.filter(function(s){return s.isPlayer})[0];return""+U()+'<div class="battlebar"><button class="backbtn" id="btnRankingBack">← 部屋一覧</button><button class="backbtn" id="btnMap">地図へ戻る</button></div><main class="league-shell"><section class="frame league-hero room-detail-hero"><div><span class="league-eyebrow">RANKING ROOM // '+d(e.code)+"</span><h2>"+w("trophy")+" "+d(e.name)+"</h2><p>"+e.members.length+'人が参加中。学習中の進捗は短い間隔でまとめてランキングへ自動反映されます。</p></div><div class="room-code"><small>招待コード</small><strong>'+d(e.code)+'</strong><button id="btnCopyCode">コピー</button></div></section><section class="frame room-board"><div class="room-section-head"><div><span class="league-eyebrow">MULTI VIEW RANKING</span><h3>'+d(Gt(n).label)+'ランキング</h3></div><div class="your-room-rank"><small>あなたの順位</small><strong>'+(i?i.rank:"-")+"位</strong></div></div>"+Na(n)+Ua(e,n)+'</section><div class="room-detail-actions"><button class="ghost" id="btnSyncProgress">'+w("review")+' 現在の進捗を反映</button><button class="ghost danger-room" id="btnRemoveRoom">この端末から部屋を削除</button></div><p class="league-local-note room-demo-note">'+(K()?"Firebaseと同期するオンラインルームです。":"現在は動作確認用ローカルルームです。")+"</p></main>"}function hn(){document.getElementById("btnHome").addEventListener("click",function(){r.screen="map",C()}),document.getElementById("rankingNickname").addEventListener("change",function(a){we(a.target.value),C()});var e=document.getElementById("btnCreateProgressSync");e&&e.addEventListener("click",async function(){this.disabled=!0;try{var a=await Rt(Un());t.settings.progressSync=a,H(t),await Fn(),C()}catch(i){document.getElementById("progressSyncError").textContent=i.message,this.disabled=!1}});var n=document.getElementById("joinProgressSyncForm");n&&n.addEventListener("submit",async function(a){a.preventDefault();try{var i=await qt(document.getElementById("progressSyncCode").value);t.settings.progressSync={syncId:i.syncId,code:i.code};var s=i.payload&&i.payload.rankingLinks,o=JSON.parse(JSON.stringify(i.payload||{}));delete o.rankingLinks,Ue=!0,Ln(o),await Qt(s),Ue=!1,Nn=i.revision||0,H(t),await Fn(),C()}catch(l){document.getElementById("progressSyncError").textContent=l.message}}),document.getElementById("createRoomForm").addEventListener("submit",async function(a){a.preventDefault();var i=St(document.getElementById("roomName").value);if(K())try{await Ht(i,De());var s=await pn(i.id);s&&Fe(s)}catch(o){document.getElementById("roomError").textContent="Firebase: "+o.message;return}r.screen="ranking-room",C()}),document.getElementById("joinRoomForm").addEventListener("submit",async function(a){a.preventDefault();var i=document.getElementById("roomCode").value;if(K())try{var s=await On(i,xe().name,ce(),De()),o=await pn(s);o&&Fe(o),r.screen="ranking-room",C()}catch(u){document.getElementById("roomError").textContent="Firebase: "+u.message}else{var l=Et(i);l.ok?(r.screen="ranking-room",C()):document.getElementById("roomError").textContent=l.error}}),Array.prototype.forEach.call(document.querySelectorAll(".room-card"),function(a){a.addEventListener("click",function(){Pt(a.getAttribute("data-room-id"))&&(r.screen="ranking-room",C())})})}function yn(){var e=te();Oa(e),document.getElementById("btnRankingBack").addEventListener("click",function(){mn(),r.screen="ranking",C()}),document.getElementById("btnMap").addEventListener("click",function(){mn(),r.screen="map",C()}),Array.prototype.forEach.call(document.querySelectorAll(".metric-tab"),function(n){n.addEventListener("click",function(){t.ranking.activeMetric=n.getAttribute("data-metric"),C()})}),Array.prototype.forEach.call(document.querySelectorAll("[data-kick-member]"),function(n){n.addEventListener("click",async function(){var a=te(),i=n.getAttribute("data-kick-name")||"このメンバー";if(!(!a||!window.confirm("「"+i+"」をこの部屋からキックしますか？"))){n.disabled=!0;try{await Tt(a.id,n.getAttribute("data-kick-member"))}catch(s){n.disabled=!1,window.alert("キックに失敗しました: "+s.message)}}})}),document.getElementById("btnSyncProgress").addEventListener("click",async function(){var n=te();if(Oe(),K()&&n)try{var a=await Wn(n,!0);a||(this.textContent="本日の同期上限です",setTimeout(function(){var i=document.getElementById("btnSyncProgress");i&&(i.textContent="進捗を同期")},1200))}catch(i){window.alert("Firebase同期に失敗しました: "+i.message)}C()}),document.getElementById("btnCopyCode").addEventListener("click",function(){var n=this,a=te();navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(a.code),n.textContent="コピー済み",setTimeout(function(){n.textContent="コピー"},1e3)}),document.getElementById("btnRemoveRoom").addEventListener("click",function(){var n=te();n&&window.confirm("「"+n.name+"」をこの端末から削除しますか？")&&(mn(),Dt(n.id),r.screen="ranking",C())})}var xn=null;function Qa(e){return!!(e&&e.queue&&e.queue.length>0&&e.pos<e.queue.length)}function U(){return'<div class="topbar"><div class="brand"><span class="glyph">⬡</span><div><h1>コード事件捜査局</h1><small>CODE CASE BUREAU // EXAM INVESTIGATION</small></div></div><div class="tally">MISSION SCORE <span class="stars num">'+z()+" / "+q+"</span></div></div>"}function Wa(){var e=N[W(t.settings.endlessUnits)]||"標準";return'<section class="codex-panel" aria-label="Codex Panel"><div class="codex-panel__header"><span class="codex-panel__eyebrow">NEW CODEX PANEL</span><h4>観測ログ</h4></div><div class="codex-panel__body"><p>新しい捜査窓口を展開しました。次の観測点をすぐ確認できます。</p><ul><li>未解決事件: '+F()+" 件</li><li>総合評価: "+z()+" / "+q+"</li><li>獲得バッジ: "+ke().filter(function(n){return n.earned}).length+" / "+ke().length+" 個</li><li>推奨難易度: "+d(e)+'</li></ul><button class="codex-panel__cta" id="btnCodexOpen" type="button">観測を開く</button></div></section>'}function Ya(){var e=pe(),n=Ce(),a=!!t.settings.soloCollapsed,i=e.missions.map(function(o){var l=o.value>=o.target,u=Math.min(100,Math.round(o.value/o.target*100));return'<li class="'+(l?"done":"")+'"><span class="solo-check">'+(l?w("check"):"○")+"</span><div><b>"+d(o.label)+"</b><small>"+Math.min(o.value,o.target)+" / "+o.target+'</small><span class="solo-mini-bar"><i style="width:'+u+'%"></i></span></div></li>'}).join(""),s=n.next?"次の「"+n.next.name+"」まで "+(n.next.min-n.points)+" pt":"最高ランクに到達";return'<section class="solo-momentum'+(a?" collapsed":"")+'"><div class="solo-head"><div><small>SOLO INVESTIGATION</small><h3>今日の一歩</h3></div><div class="solo-head-actions"><span class="solo-streak">'+w("spark")+" "+e.streak+'日</span><button type="button" id="btnSoloCollapse" aria-expanded="'+!a+'" aria-label="'+(a?"今日の一歩を展開":"今日の一歩を最小化")+'">'+(a?"＋":"−")+'</button></div></div><div class="solo-content"><ul class="solo-missions">'+i+'</ul><div class="solo-rank"><span><small>現在の階級</small><b>'+d(n.name)+"</b></span><strong>"+n.points+' pt</strong></div><div class="solo-rank-bar"><i style="width:'+n.percent+'%"></i></div><p>'+d(s)+" ・ 1日最高 "+e.bestDayCorrect+"正解</p>"+(e.completed===3?'<div class="solo-complete">'+w("trophy")+" 本日の捜査目標を全達成！</div>":"")+"</div></section>"}function ke(){var e=[],n=z(),a=Object.keys(t.stars).filter(function(k){return(t.stars[k]||0)>0}).length,i=(t.endless.correct||0)+(t.endless.wrong||0),s=i>0?Math.round((t.endless.correct||0)/i*100):0,o=Object.keys(t.studyCompleted||{}).filter(function(k){return!!t.studyCompleted[k]}).length,l=Object.keys(t.studyMedal||{}).filter(function(k){return!!t.studyMedal[k]}).length,u=pe(),b=Object.keys(t.activity&&t.activity.days||{}).filter(function(k){var T=t.activity.days[k]||{};return(T.answers||0)+(T.studySteps||0)+(T.reviewsCleared||0)>0}).length,f=Object.keys(t.activity&&t.activity.days||{}).reduce(function(k,T){return k+((t.activity.days[T]||{}).reviewsCleared||0)},0),y=t.ranking&&Array.isArray(t.ranking.rooms)?t.ranking.rooms:[],g=y.reduce(function(k,T){return Math.max(k,(T.members||[]).length)},0),P=Ce().points,E=0;Object.keys(t.unitStats||{}).forEach(function(k){var T=t.unitStats[k]||{};(T.correct||0)>=5&&(T.wrong||0)===0&&E++});var _={初回突破:{how:"いずれかの事件でスターを1個以上獲得する",current:n,target:1,unit:"個"},序盤制圧:{how:"スターを合計3個獲得する",current:n,target:3,unit:"個"},中盤の切り札:{how:"スターを合計9個獲得する",current:n,target:9,unit:"個"},捜査の手応え:{how:"スターを合計15個獲得する",current:n,target:15,unit:"個"},上級捜査官:{how:"スターを合計20個獲得する",current:n,target:20,unit:"個"},伝説の実力者:{how:"スターを合計30個獲得する",current:n,target:30,unit:"個"},完全制覇:{how:"全事件で最大数のスターを集める",current:n,target:q,unit:"個"},半分の証拠:{how:"全事件の半分以上をクリアする",current:a,target:Math.ceil(D.length/2),unit:"章"},全章制覇:{how:"すべての事件を1回以上クリアする",current:a,target:D.length,unit:"章"},無傷の捜査:{how:"間違いノートを0件にする",current:F(),target:0,unit:"件",lowerIsBetter:!0},短期連勝:{how:"1000本ノックで3問連続正解する",current:t.endless.bestStreak||0,target:3,unit:"問"},連勝の極意:{how:"1000本ノックで8問連続正解する",current:t.endless.bestStreak||0,target:8,unit:"問"},連鎖突破:{how:"1000本ノックで15問連続正解する",current:t.endless.bestStreak||0,target:15,unit:"問"},"50本ノック達成":{how:"1000本ノックで累計50問に回答する",current:i,target:50,unit:"問"},"100本ノック達成":{how:"1000本ノックで累計100問に回答する",current:i,target:100,unit:"問"},"300本ノック達成":{how:"1000本ノックで累計300問に回答する",current:i,target:300,unit:"問"},"1000本ノック達成":{how:"1000本ノックで累計1000問に回答する",current:i,target:1e3,unit:"問"},高精度の捜査:{how:"1000本ノックを20問以上解き、正答率80%以上にする",current:s,target:80,unit:"%",note:"回答数 "+i+" / 20問"},正答率の鬼:{how:"1000本ノックを20問以上解き、正答率90%以上にする",current:s,target:90,unit:"%",note:"回答数 "+i+" / 20問"},学習ログ起動:{how:"学習パートを3章完了する",current:o,target:3,unit:"章"},学びの習慣:{how:"学習パートを6章完了する",current:o,target:6,unit:"章"},証拠を読み切る:{how:"学習パートを10章完了する",current:o,target:10,unit:"章"},学習モード:{how:"ホームで章選択の動作を「証拠を読む」に切り替える",current:t.settings.studyModeActive?1:0,target:1,unit:"回"},別解採用:{how:"ホームで「別解 採用」をオンにする",current:t.settings.allowAlt?1:0,target:1,unit:"回"},双方向攻略:{how:"学習モードと別解採用を両方オンにする",current:(t.settings.studyModeActive?1:0)+(t.settings.allowAlt?1:0),target:2,unit:"設定"},単元を極めた:{how:"同じ単元で5問以上正解し、誤答0を保つ",current:E,target:1,unit:"単元"},弱点を克服:{how:"3単元で5問以上正解し、誤答0を保つ",current:E,target:3,unit:"単元"},捜査条件を絞る:{how:"1000本ノックの対象単元を絞り込む",current:t.settings.endlessUnits&&t.settings.endlessUnits.length?1:0,target:1,unit:"設定"},難易度を見極める:{how:"1000本ノックの難易度を絞り込む",current:t.settings.endlessDiffs&&t.settings.endlessDiffs.length?1:0,target:1,unit:"設定"},重要度に着目:{how:"1000本ノックの重要度を絞り込む",current:t.settings.endlessTiers&&t.settings.endlessTiers.length?1:0,target:1,unit:"設定"},勉強の証:{how:"いずれかの学習パートを完了してメダルを獲得する",current:Object.keys(t.studyMedal||{}).length,target:1,unit:"個"},証拠収集家:{how:"学習メダルを5個集める",current:l,target:5,unit:"個"},資料室の主:{how:"学習メダルを10個集める",current:l,target:10,unit:"個"},現場百問:{how:"通常問題で累計100問正解する",current:Object.keys(t.unitStats||{}).reduce(function(k,T){return k+(t.unitStats[T].correct||0)},0),target:100,unit:"問"},復習捜査官:{how:"間違いノートの問題を5問解決する",current:f,target:5,unit:"問"},弱点封鎖:{how:"間違いノートの問題を20問解決する",current:f,target:20,unit:"問"},二日連続出動:{how:"2日連続で学習活動を記録する",current:u.streak,target:2,unit:"日"},一週間の張り込み:{how:"7日連続で学習活動を記録する",current:u.streak,target:7,unit:"日"},常連捜査員:{how:"合計30日で学習活動を記録する",current:b,target:30,unit:"日"},捜査会議を設置:{how:"ランキング部屋を1つ作成または参加する",current:y.length,target:1,unit:"室"},合同捜査:{how:"5人以上が登録されたランキング部屋に入る",current:g,target:5,unit:"人"},大規模捜査本部:{how:"10人以上が登録されたランキング部屋に入る",current:g,target:10,unit:"人"},名乗りを上げる:{how:"ユーザー名を「あなた」以外に変更する",current:t.ranking&&t.ranking.nickname&&t.ranking.nickname!=="あなた"?1:0,target:1,unit:"回"},事件解析官:{how:"捜査階級ポイントを300pt以上にする",current:P,target:300,unit:"pt"},首席コード探偵:{how:"捜査階級ポイントを1400pt以上にする",current:P,target:1400,unit:"pt"},まだ一歩目:{how:"最初の学習や事件捜査を始める前に与えられる記念バッジ",current:n+i+o===0?1:0,target:1,unit:"個"}};function p(k,T,de,se,Z){var G=!!Z,V=_[k]||{how:"条件を満たすと取得できます",current:G?1:0,target:1,unit:"回"};e.push({label:k,rarity:T||"common",tone:de||"neutral",batch:se||"base",earned:G,how:V.how,current:V.current,target:V.target,unit:V.unit||"",lowerIsBetter:!!V.lowerIsBetter,note:V.note||""})}var x={base:!0,standard:n>=9||a>=3||i>=50,advanced:n>=20||i>=200||o>=6,legendary:n>=q||i>=1e3||t.endless.bestStreak>=15};p("初回突破","common","good","base",n>0),p("序盤制圧","common","good","base",n>=3),p("中盤の切り札","common","good","standard",n>=9),p("捜査の手応え","rare","good","standard",n>=15),p("上級捜査官","rare","good","advanced",n>=20),p("伝説の実力者","epic","good","advanced",n>=30),p("完全制覇","legendary","good","legendary",n>=q),p("半分の証拠","common","good","standard",a>=Math.ceil(D.length/2)),p("全章制覇","rare","good","advanced",a>=D.length),p("無傷の捜査","rare","good","advanced",n>0&&F()===0),p("短期連勝","common","good","base",t.endless.bestStreak>=3),p("連勝の極意","rare","good","standard",t.endless.bestStreak>=8),p("連鎖突破","epic","good","legendary",t.endless.bestStreak>=15),p("50本ノック達成","common","good","standard",i>=50),p("100本ノック達成","rare","good","advanced",i>=100),p("300本ノック達成","epic","good","advanced",i>=300),p("1000本ノック達成","legendary","good","legendary",i>=1e3),p("高精度の捜査","rare","good","standard",s>=80&&i>=20),p("正答率の鬼","epic","good","advanced",s>=90&&i>=20),p("学習ログ起動","common","neutral","base",o>=3),p("学びの習慣","common","neutral","standard",o>=6),p("証拠を読み切る","rare","neutral","advanced",o>=10),p("学習モード","common","neutral","base",t.settings.studyModeActive),p("別解採用","common","neutral","base",t.settings.allowAlt),p("双方向攻略","rare","neutral","advanced",t.settings.studyModeActive&&t.settings.allowAlt),p("単元を極めた","rare","neutral","standard",E>=1),p("弱点を克服","epic","neutral","advanced",E>=3),p("捜査条件を絞る","common","neutral","base",!!(t.settings.endlessUnits&&t.settings.endlessUnits.length)),p("難易度を見極める","common","neutral","standard",!!(t.settings.endlessDiffs&&t.settings.endlessDiffs.length)),p("重要度に着目","rare","neutral","advanced",!!(t.settings.endlessTiers&&t.settings.endlessTiers.length)),p("勉強の証","common","neutral","base",!!Object.keys(t.studyMedal||{}).some(function(k){return!!t.studyMedal[k]})),p("証拠収集家","rare","neutral","study",l>=5),p("資料室の主","epic","neutral","study",l>=10),p("現場百問","rare","good","case",_.現場百問.current>=100),p("復習捜査官","rare","good","case",f>=5),p("弱点封鎖","epic","good","case",f>=20),p("二日連続出動","common","neutral","special",u.streak>=2),p("一週間の張り込み","epic","neutral","special",u.streak>=7),p("常連捜査員","legendary","neutral","special",b>=30),p("捜査会議を設置","common","good","league",y.length>=1),p("合同捜査","rare","good","league",g>=5),p("大規模捜査本部","epic","good","league",g>=10),p("名乗りを上げる","common","neutral","league",!!(t.ranking&&t.ranking.nickname&&t.ranking.nickname!=="あなた")),p("事件解析官","rare","good","special",P>=300),p("首席コード探偵","legendary","good","special",P>=1400),p("まだ一歩目","common","neutral","base",n===0&&i===0&&o===0);var m=["初回突破","序盤制圧","中盤の切り札","捜査の手応え","上級捜査官","伝説の実力者","完全制覇","半分の証拠","全章制覇","無傷の捜査","単元を極めた","弱点を克服"],A=["学習ログ起動","学びの習慣","証拠を読み切る","学習モード","勉強の証","証拠収集家","資料室の主"],B=["短期連勝","連勝の極意","連鎖突破","50本ノック達成","100本ノック達成","300本ノック達成","1000本ノック達成","高精度の捜査","正答率の鬼","捜査条件を絞る","難易度を見極める","重要度に着目"],M=["捜査会議を設置","合同捜査","大規模捜査本部","名乗りを上げる"];e.forEach(function(k){m.indexOf(k.label)!==-1?k.batch="case":A.indexOf(k.label)!==-1?k.batch="study":B.indexOf(k.label)!==-1?k.batch="training":M.indexOf(k.label)!==-1?k.batch="league":k.batch="special"});var O=typeof window<"u"&&new URLSearchParams(window.location.search).get("demo")==="all";return O&&e.forEach(function(k){k.earned=!0,k.note="全取得デモ表示"}),e}function Ga(){var e=Object.keys(t.stars).filter(function(a){return(t.stars[a]||0)>0}).length,n=ke().map(function(a){return a.label}).join(" / ");return`コード事件捜査局 進捗状況
ユーザー名: `+(t.ranking.nickname||"あなた")+`
総合評価: `+z()+" / "+q+`
解決済みケース: `+e+" / "+D.length+`
実績: `+n}function wn(){return(!t.showcase||typeof t.showcase!="object")&&(t.showcase={achievementLabels:null}),t.showcase}function Ka(){var e=Object.keys(t.stars).filter(function(f){return(t.stars[f]||0)>0}).length,n=t.ranking.nickname||"あなた",a=ke(),i=a.filter(function(f){return f.earned}).length,s=wn();if(!Array.isArray(s.achievementLabels)||s.achievementLabels.length!==5){for(var o=a.filter(function(f){return f.earned}).slice(0,5).map(function(f){return f.label});o.length<5;)o.push(null);s.achievementLabels=o,H(t)}var l=s.achievementLabels.map(function(f,y){var g=a.filter(function(E){return E.label===f&&E.earned})[0];if(!g)return'<li class="codex-showcase__achievement empty" data-showcase-slot="'+y+'"><span>実績をここへドロップ</span></li>';var P="codex-showcase__achievement--"+(g.rarity||"common");return'<li class="codex-showcase__achievement '+g.tone+" "+P+'" data-showcase-slot="'+y+'" draggable="true" data-achievement-label="'+d(g.label)+'"><span>'+d(g.label)+'</span><button type="button" data-clear-showcase="'+y+'" aria-label="'+d(g.label)+'を外す">×</button></li>'}).join(""),u=a.filter(function(f){return f.earned}).map(function(f){return'<button type="button" class="codex-showcase__source '+f.tone+" codex-showcase__source--"+(f.rarity||"common")+'" draggable="true" data-showcase-source="'+d(f.label)+'"><span>'+d(f.label)+"</span></button>"}).join(""),b=z()>=q?"全事件を完全制覇":e===0?"最初の事件を捜査中":"全"+D.length+"件中 "+e+"件を解決済み";return'<div class="codex-showcase" id="codexShowcase"><div class="codex-showcase__header"><span class="codex-showcase__eyebrow">PROGRESS STATUS</span><h6>進捗状況</h6></div><div class="codex-showcase__body"><label class="codex-showcase__identity"><span>ユーザー名</span><input id="showcaseUsername" maxlength="16" value="'+d(n)+'"></label><div class="codex-showcase__hero"><div class="codex-showcase__stamp">★ '+z()+" / "+q+'</div><div class="codex-showcase__quote">'+d(b)+'</div></div><div class="codex-showcase__metrics"><div class="codex-showcase__metric"><span>解決済みケース</span><strong>'+e+" / "+D.length+'</strong></div><div class="codex-showcase__metric"><span>未解決イベント</span><strong>'+F()+' 件</strong></div><div class="codex-showcase__metric"><span>推奨難易度</span><strong>'+d(N[W(t.settings.endlessUnits)]||"標準")+'</strong></div><div class="codex-showcase__metric"><span>獲得バッジ</span><strong>'+i+" / "+a.length+'</strong></div></div><div class="codex-showcase__achievement-head"><span>表示する実績</span><small>下の実績から5枠へドラッグ</small></div><div class="codex-showcase__tray" aria-label="取得済み実績">'+u+'</div><ul class="codex-showcase__achievements">'+l+"</ul></div></div>"}function Xa(e){var n=e.querySelector("#codexShowcase");if(!n)return;var a=document.createElement("canvas"),i=1200,s=630,o=window.devicePixelRatio||1;a.width=i*o,a.height=s*o;var l=a.getContext("2d");l.scale(o,o);function u(x,m,A,B,M){if(l.roundRect){l.roundRect(x,m,A,B,M);return}l.beginPath(),l.moveTo(x+M,m),l.arcTo(x+A,m,x+A,m+B,M),l.arcTo(x+A,m+B,x,m+B,M),l.arcTo(x,m+B,x,m,M),l.arcTo(x,m,x+A,m,M),l.closePath()}var b=l.createLinearGradient(0,0,i,s);b.addColorStop(0,"#241a13"),b.addColorStop(1,"#5a2b20"),l.fillStyle=b,l.fillRect(0,0,i,s),l.fillStyle="rgba(255,255,255,0.08)";for(var f=0;f<12;f++)l.beginPath(),l.arc(70+f%6*210,110+Math.floor(f/6)*360,58,0,Math.PI*2),l.fill();l.save(),l.translate(40,40),l.fillStyle="#f3e4bc",u(0,0,i-80,s-80,34),l.fill(),l.lineWidth=3,l.strokeStyle="#b78d4d",l.stroke(),l.restore(),l.fillStyle="#8d302b",l.font='bold 25px "Hiragino Mincho ProN", serif',l.fillText("コード事件捜査局",80,98),l.fillStyle="#2b2318",l.font='700 46px "Hiragino Mincho ProN", serif',l.fillText("進捗状況",80,155),l.fillStyle="#6b5b3e",l.font='600 23px "Hiragino Kaku Gothic ProN", sans-serif',l.fillText("ユーザー名  "+(t.ranking.nickname||"あなた"),80,205),l.fillText("総合評価  "+z()+" / "+q,80,270),l.fillText("解決済み案件  "+Object.keys(t.stars).filter(function(x){return(t.stars[x]||0)>0}).length+" / "+D.length,80,320),l.fillText("未解決イベント  "+F()+" 件",80,370),l.fillText("推奨難易度  "+(N[W(t.settings.endlessUnits)]||"標準"),80,420);var y=ke();l.fillText("獲得バッジ  "+y.filter(function(x){return x.earned}).length+" / "+y.length,80,470),l.fillStyle="#4f3b24",l.font='700 25px "Hiragino Kaku Gothic ProN", sans-serif',l.fillText("選択した実績",685,145);var g=ke(),P=wn(),E=Array.isArray(P.achievementLabels)?P.achievementLabels:[],_=E.map(function(x){return g.filter(function(m){return m.label===x&&m.earned})[0]}).filter(Boolean).slice(0,5);_.forEach(function(x,m){var A=205+m*64;l.fillStyle=x.tone==="good"?"#8d302b":"#3f6a8a",l.fillRect(685,A-18,15,15),l.fillStyle="#2b2318",l.font='600 22px "Hiragino Kaku Gothic ProN", sans-serif',l.fillText(x.label,720,A)}),l.fillStyle="#6b5b3e",l.font='600 18px "Hiragino Kaku Gothic ProN", sans-serif',l.fillText("CODE CASE BUREAU // PROGRESS CARD",80,545);var p=document.createElement("a");p.download="コード事件捜査局_進捗.png",p.href=a.toDataURL("image/png"),p.click()}function Xt(e){if(!e)return;var n=e.querySelector(".codex-overlay");n&&n.remove();var a=Object.keys(t.stars).filter(function(c){return(t.stars[c]||0)>0}).length,i=[],s=ke();s.forEach(function(c,v){c.detailIndex=v});var o=0,l={case:"事件捜査",study:"学習記録",training:"連続演習",league:"ランキング",special:"特別捜査"},u=["common","rare","epic","legendary"],b={common:"一般バッジ",rare:"希少バッジ",epic:"稀バッジ",legendary:"伝説バッジ"},f=["case","study","training","league","special"];u.forEach(function(c){var v=s.filter(function(L){return(L.rarity||"common")===c});v.sort(function(L,ge){return f.indexOf(L.batch)-f.indexOf(ge.batch)});for(var h=0;h<v.length;h+=6){var S=v.slice(h,h+6),I="■ "+b[c]+(v.length>6?" "+(Math.floor(h/6)+1):""),R='<ul class="codex-achievements codex-achievement-page" data-achievement-page="'+o+'"'+(o?" hidden":"")+'><li class="codex-achievement-group">'+d(I)+"</li>";S.forEach(function(L){var ge=L.rarity==="legendary"?"【伝説】":L.rarity==="epic"?"【稀】":L.rarity==="rare"?"【希少】":"【一般】",En=L.earned?"codex-achievement--earned":"codex-achievement--locked",Pn=L.earned?' draggable="true" data-achievement-label="'+d(L.label)+'"':' aria-disabled="true"';R+='<li><button type="button" class="codex-achievement '+L.tone+" codex-achievement--"+(L.rarity||"common")+" "+En+'" data-achievement-index="'+L.detailIndex+'"'+Pn+"><span>"+d(ge)+" "+d(L.label)+'</span><span class="codex-achievement__batch">'+d(l[L.batch]||"特別捜査")+" · "+d(L.earned?"取得済み":"未取得")+" ›</span></button></li>"}),i.push(R+"</ul>"),o++}}),i=i.join("");var y=Ga(),g=Ka(),P='<div class="codex-overlay" role="dialog" aria-modal="true" aria-label="進捗と実績"><div class="codex-sheet"><button class="codex-sheet__close" id="btnCodexClose" type="button" aria-label="閉じる">×</button><div class="codex-sheet__header"><span class="codex-panel__eyebrow">SHAREABLE PROGRESS</span><h4>進捗と実績</h4></div><div class="codex-sheet__grid"><section class="codex-card"><h5>進捗</h5><ul class="codex-metrics"><li><span>総合評価</span><strong>'+z()+" / "+q+"</strong></li><li><span>解決済みケース</span><strong>"+a+" / "+D.length+"</strong></li><li><span>未解決イベント</span><strong>"+F()+" 件</strong></li><li><span>推奨難易度</span><strong>"+d(N[W(t.settings.endlessUnits)]||"標準")+"</strong></li><li><span>獲得バッジ</span><strong>"+s.filter(function(c){return c.earned}).length+" / "+s.length+' 個</strong></li></ul></section><section class="codex-card"><h5>実績</h5><div class="codex-achievement-pages">'+i+'</div><div class="codex-achievement-pager"><button type="button" id="btnAchievementPrev" aria-label="前の実績ページ">← 前へ</button><span id="achievementPageStatus">1 / '+o+'</span><button type="button" id="btnAchievementNext" aria-label="次の実績ページ">次へ →</button></div></section></div><div class="codex-share"><p class="codex-share__label">進捗状況プレビュー</p><div class="codex-share__preview">'+g+'</div><p class="codex-share__label">共有メッセージ</p><textarea class="codex-share__textarea" readonly>'+d(y)+'</textarea><div class="codex-share__actions"><button class="codex-panel__cta" id="btnSaveCodexPhoto" type="button">写真にする</button><button class="codex-panel__cta" id="btnCopyCodexShare" type="button">コピーする</button><button class="codex-panel__secondary" id="btnShareCodex" type="button">共有する</button></div></div></div><div class="codex-achievement-popover" id="achievementPopover" role="tooltip" hidden></div></div>';e.insertAdjacentHTML("beforeend",P);var E=e.querySelector(".codex-sheet");E&&E.addEventListener("click",function(c){c.stopPropagation()});function _(){var c=E?E.scrollTop:0,v=window.scrollX,h=window.scrollY;Xt(e);var S=e.querySelector(".codex-sheet");S&&(S.scrollTop=c),window.scrollTo(v,h),requestAnimationFrame(function(){var I=e.querySelector(".codex-sheet");I&&(I.scrollTop=c),window.scrollTo(v,h)})}var p=e.querySelector(".codex-overlay");p&&p.addEventListener("click",function(){p.remove()});var x=e.querySelector("#btnCodexClose");x&&x.addEventListener("click",function(){p.remove()});var m=e.querySelector("#achievementPopover"),A=0,B=e.querySelectorAll("[data-achievement-page]"),M=e.querySelector("#achievementPageStatus"),O=e.querySelector("#btnAchievementPrev"),k=e.querySelector("#btnAchievementNext");function T(c){A=Math.max(0,Math.min(B.length-1,c)),Array.prototype.forEach.call(B,function(v,h){v.hidden=h!==A}),M&&(M.textContent=A+1+" / "+B.length),O&&(O.disabled=A===0),k&&(k.disabled=A===B.length-1),m&&(m.hidden=!0)}O&&O.addEventListener("click",function(){T(A-1)}),k&&k.addEventListener("click",function(){T(A+1)}),T(0);function de(c){var v;c.earned?v="条件達成済み":c.lowerIsBetter?v="あと "+Math.max(0,c.current-c.target)+" "+c.unit+"減らす":v="あと "+Math.max(0,c.target-c.current)+" "+c.unit;var h=c.current+" "+c.unit+" / 目標 "+c.target+" "+c.unit;return'<span class="codex-achievement-detail__eyebrow">'+d(c.earned?"UNLOCKED":"HOW TO UNLOCK")+"</span><b>"+d(c.label)+"</b><p>"+d(c.how)+'</p><div class="codex-achievement-detail__progress"><span>'+d(h)+"</span><strong>"+d(v)+"</strong></div>"+(c.note?"<small>"+d(c.note)+"</small>":"")}function se(c,v){if(m){var h=14,S=m.offsetWidth||280,I=m.offsetHeight||150,R=c+h,L=v+8;R+S>window.innerWidth-10&&(R=Math.max(10,c-S-h)),L+I>window.innerHeight-10&&(L=Math.max(10,window.innerHeight-I-10)),m.style.left=R+"px",m.style.top=L+"px"}}function Z(c,v,h,S){if(!(!m||!v)){if(m.innerHTML=de(v),m.hidden=!1,Array.prototype.forEach.call(e.querySelectorAll("[data-achievement-index]"),function(R){R.classList.remove("selected")}),c.classList.add("selected"),typeof h!="number"){var I=c.getBoundingClientRect();h=I.right,S=I.top}se(h,S)}}function G(c){m&&(m.hidden=!0),c&&c.classList.remove("selected")}var V=null;function J(c){V=c,Array.prototype.forEach.call(e.querySelectorAll("[data-achievement-index]"),function(v){v.classList.toggle("picked",v.getAttribute("data-achievement-label")===c)}),Array.prototype.forEach.call(e.querySelectorAll("[data-showcase-source]"),function(v){v.classList.toggle("picked",v.getAttribute("data-showcase-source")===c)})}function Me(c,v){var h=s.some(function(R){return R.earned&&R.label===v});if(h){for(var S=wn(),I=Array.isArray(S.achievementLabels)?S.achievementLabels.slice(0,5):[null,null,null,null,null];I.length<5;)I.push(null);I=I.map(function(R,L){return R===v&&L!==c?null:R}),I[c]=v,S.achievementLabels=I,H(t),_()}}Array.prototype.forEach.call(e.querySelectorAll("[data-achievement-index]"),function(c){var v=s[parseInt(c.getAttribute("data-achievement-index"),10)];v.earned&&c.addEventListener("dragstart",function(h){J(v.label),h.dataTransfer&&(h.dataTransfer.effectAllowed="move",h.dataTransfer.setData("text/plain",v.label))}),c.addEventListener("pointerenter",function(h){h.pointerType!=="touch"&&Z(c,v,h.clientX,h.clientY)}),c.addEventListener("pointermove",function(h){h.pointerType!=="touch"&&m&&!m.hidden&&se(h.clientX,h.clientY)}),c.addEventListener("pointerleave",function(h){h.pointerType!=="touch"&&G(c)}),c.addEventListener("focus",function(){Z(c,v)}),c.addEventListener("blur",function(){G(c)}),c.addEventListener("click",function(h){v.earned&&J(v.label),(h.pointerType==="touch"||!window.matchMedia("(hover:hover)").matches)&&(m&&!m.hidden&&c.classList.contains("selected")?G(c):Z(c,v,h.clientX||void 0,h.clientY||void 0))})}),Array.prototype.forEach.call(e.querySelectorAll("[data-showcase-source]"),function(c){var v=c.getAttribute("data-showcase-source");c.addEventListener("dragstart",function(h){J(v),h.dataTransfer&&(h.dataTransfer.effectAllowed="copy",h.dataTransfer.setData("text/plain",v))}),c.addEventListener("click",function(){J(v)})}),Array.prototype.forEach.call(e.querySelectorAll("[data-showcase-slot]"),function(c){var v=parseInt(c.getAttribute("data-showcase-slot"),10),h=c.getAttribute("data-achievement-label");h&&c.addEventListener("dragstart",function(S){J(h),S.dataTransfer&&(S.dataTransfer.effectAllowed="move",S.dataTransfer.setData("text/plain",h))}),c.addEventListener("dragover",function(S){S.preventDefault(),c.classList.add("dragover"),S.dataTransfer&&(S.dataTransfer.dropEffect="move")}),c.addEventListener("dragleave",function(){c.classList.remove("dragover")}),c.addEventListener("drop",function(S){S.preventDefault(),c.classList.remove("dragover");var I=S.dataTransfer?S.dataTransfer.getData("text/plain"):V;I&&Me(v,I)}),c.addEventListener("click",function(S){S.target.closest("[data-clear-showcase]")||V&&Me(v,V)})}),Array.prototype.forEach.call(e.querySelectorAll("[data-clear-showcase]"),function(c){c.addEventListener("click",function(v){v.stopPropagation();var h=parseInt(c.getAttribute("data-clear-showcase"),10),S=wn(),I=Array.isArray(S.achievementLabels)?S.achievementLabels.slice(0,5):[null,null,null,null,null];I[h]=null,S.achievementLabels=I,H(t),_()})});var le=e.querySelector("#showcaseUsername");le&&(le.addEventListener("click",function(c){c.stopPropagation()}),le.addEventListener("change",function(){we(le.value),_()}));var oe=e.querySelector("#btnCopyCodexShare");oe&&oe.addEventListener("click",function(){navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(y).then(function(){oe.textContent="コピー済み"}):oe.textContent="コピーできません"});var me=e.querySelector("#btnShareCodex");me&&me.addEventListener("click",function(){navigator.share?navigator.share({title:"コード事件捜査局 進捗",text:y}).catch(function(){}):navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(y).then(function(){me.textContent="共有文をコピー"})});var $=e.querySelector("#btnSaveCodexPhoto");$&&$.addEventListener("click",function(){Xa(e),$.textContent="保存しました",setTimeout(function(){$&&($.textContent="写真にする")},1400)})}var Za=["第1部 C++入門 ― 入出力・ポインタ・関数","第2部 データ構造 ― 配列・文字列・構造体","第3部 クラス設計 ― 基本から後片付けまで","第4部 継承と多態性","第5部 Pythonへの転生 ― クラスとTkinter"];function Ja(){var e=!!t.settings.studyModeActive,n="",a=0,i=[];function s(){i.length&&(n+='<h3 class="groupheading">'+d(Za[a]||"第"+(a+1)+"部")+'</h3><div class="stagegrid'+(e?" study-mode":"")+'">'+i.join("")+"</div>",i=[])}D.forEach(function(_,p){var x=t.stars[_.id]||0,m=!!t.studyCompleted[_.id],A=t.studyMedal[_.id],B=m?'<span class="studydonebadge">'+w(A?"trophy":"check")+" 学習済み</span>":e?'<span class="studyhint">'+w("book")+" 学習パートへ</span>":"";i.push('<button class="stagecard'+(_.isBoss?" boss":"")+'" data-idx="'+p+'" aria-label="'+d(_.title)+'"><div class="row1"><span class="emoji">'+ie(_.id,_.isBoss)+'</span><span class="idx">'+(_.isBoss?"BOSS NODE":"NODE "+String(p+1).padStart(2,"0"))+"</span></div><h3>"+d(_.title)+'</h3><div class="sub">'+d(_.sub)+" ・ "+d(_.mon)+"</div>"+B+'<div class="stars">'+Se(x)+"</div></button>"),_.isBoss&&(s(),a++)}),s();var o=t.endless,l=o.correct+o.wrong,u=l>0?Math.round(o.correct/l*100):0,b=t.settings.endlessUnits,f=t.settings.endlessDiffs,y=t.settings.endlessTiers,g=!b||b.length===0?"対象: 全"+Q.length+"単元":"対象: "+b.length+"/"+Q.length+"単元に絞り込み中";g+=!f||f.length===0?" ・ 難易度: 全て":" ・ 難易度: "+f.map(function(_){return N[_]}).join("/"),g+=!y||y.length===0?" ・ 重要度: 全て":" ・ 重要度: "+y.map(function(_){return ae[_]}).join("/");var P=W(b),E=F();return""+U()+'<main class="case-office"><aside class="case-sidebar"><div class="office-plate"><span>'+w("target")+'</span><div><small>BUG INVESTIGATION UNIT</small><h2>事件管理簿</h2></div></div><button class="case-nav active"><span>'+w("archive")+"</span><b>事件一覧</b><small>"+D.length+'件</small></button><button class="case-nav league-nav" id="btnRanking"><span>'+w("trophy")+'</span><b>ランキング</b><small>ルームで競う</small></button><button class="case-nav" id="btnEndless"><span>'+w("terminal")+'</span><b>総合捜査</b><small>1000本ノック</small></button><button class="case-nav" id="btnReview2"><span>'+w("review")+"</span><b>未解決</b><small>"+E+'件</small></button><button class="case-nav" id="btnUnitPicker"><span>'+w("target")+"</span><b>捜査条件</b><small>"+d(N[P])+'</small></button><div class="case-stats"><h3>捜査記録</h3><dl><div><dt>解決評価</dt><dd class="num">'+z()+" / "+q+'</dd></div><div><dt>連続正解</dt><dd class="num">'+o.streak+'</dd></div><div><dt>正答率</dt><dd class="num">'+u+'%</dd></div></dl></div><button class="mode-file '+(e?"study":"quest")+'" id="btnModeToggle" aria-pressed="'+(e?"true":"false")+'"><span>'+w(e?"book":"sword")+"</span><b>"+(e?"証拠を読む":"推理に挑む")+'</b><small>章選択時の動作</small></button><button class="alt-file'+(t.settings.allowAlt?" on":"")+'" id="btnAltToggle" aria-pressed="'+(t.settings.allowAlt?"true":"false")+'"><span class="alt-file-label">'+w(t.settings.allowAlt?"unlock":"lock")+" 別解 "+(t.settings.allowAlt?"採用":"不採用")+'</span><span class="alt-switch" aria-hidden="true"><span class="alt-switch-knob"></span></span></button></aside><section class="evidence-board"><header class="board-head"><div><small>ACTIVE CASE FILES</small><h2>プログラム事件一覧</h2></div><p>不具合の証拠を読み、すべての事件を解決せよ。</p></header>'+Ya()+'<div class="case-scroll">'+n+'</div></section><aside class="desk-evidence"><div class="desk-lamp">'+w("search")+"</div><h3>本日の捜査</h3><p>"+d(g)+"</p><dl><div><dt>連続解決</dt><dd>"+o.streak+"</dd></div><div><dt>最高記録</dt><dd>"+o.bestStreak+"</dd></div></dl>"+(Qa(o)?'<button id="btnEndlessResume" class="resume-file">'+w("review")+" 前回の捜査を再開("+(o.queue.length-o.pos)+"問残り)</button>":"")+'<button id="btnEndlessDesk">捜査を開始</button>'+Wa()+'</aside></main><p class="footer-note">捜査記録はこの端末に自動保存されます。</p>'}function Le(e,n){r.stageIndex=e,r.screen="lesson",r.lessonFromBattle=!!n,C()}function Yn(){Je(),r.curQ=null,r.locked=!1,r.screen="endless",C()}function Kt(){var e=Object.keys(t.missed);r.reviewQueue=en(e.map(function(n){return qe[n]}).filter(function(n){return n!==void 0})),r.reviewPos=0,r.reviewStats={correct:0,wrong:0},r.curQ=null,r.locked=!1,r.screen="review",C()}function $a(){var e=r.reviewQueue[r.reviewPos];return j[e]}function er(){if(r.reviewQueue.length===0)return""+U()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button></div><div class="frame result"><span class="bigemoji">'+w("check")+'</span><h2>間違いノートは空っぽです</h2><p>今のところ間違えた問題は記録されていません。各章の戦闘や1000本ノックで間違えると、その問題が自動的にここへ集まってきます。</p><div class="resultbtns"><button class="ghost" id="btnMap">地図へ戻る</button></div></div>';if(r.reviewPos>=r.reviewQueue.length){var e=F();return""+U()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button></div><div class="frame result"><span class="bigemoji">'+w("review")+"</span><h2>この周の復習が終わりました</h2><p>正解 "+r.reviewStats.correct+"問 ／ 誤答 "+r.reviewStats.wrong+"問。間違いノートには、まだ"+e+'問残っています。</p><div class="resultbtns">'+(e>0?'<button class="primary" id="btnReviewAgain">もう一度復習する →</button>':"")+'<button class="ghost" id="btnMap">地図へ戻る</button></div></div>'}if(!r.curQ){var n=$a();r.curQ=n.q,r.endlessSrc=n}var a=Ee(r.curQ);return""+U()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button></div><div class="frame endlessbar"><div class="estat"><span class="elabel">出題元</span><span class="evalue">'+d(r.endlessSrc.srcTitle)+'</span></div><div class="estat"><span class="elabel">この周の進捗</span><span class="evalue">'+(r.reviewPos+1)+" / "+r.reviewQueue.length+'</span></div><div class="estat"><span class="elabel">間違いノート残り</span><span class="evalue">'+F()+'問</span></div></div><div class="frame qcard" id="qcard"><div class="qmeta"><span>'+w("review")+' 復習モード <span class="tierbadge t'+r.endlessSrc.tier+'">'+d(ae[r.endlessSrc.tier])+"</span></span><span>"+d(r.endlessSrc.srcSub)+'</span></div><div class="qlead">'+a.qlead+"</div>"+a.bodyHtml+a.answerHtml+'</div><div id="feedbackSlot"></div>'}function nr(e){var n=D[r.stageIndex],a=1;if(e){var i=r.heroHP/100;r.wrong===0?a=3:i>=.5?a=2:a=1;var s=t.stars[n.id]||0;a>s&&(t.stars[n.id]=a),r.stageIndex+2>t.unlocked&&(t.unlocked=r.stageIndex+2),t.unlocked>D.length&&(t.unlocked=D.length),H(t)}var o=r.failReason==="outofq"?'<span class="bigemoji">'+w("alert")+"</span><h2>ミッション未完了</h2><p>設問はすべて解き終えたが、"+d(n.mon)+"にはまだ息がある。誤答が多いと決定打が足りない。訓練場で復習してもう一度挑もう。</p>":'<span class="bigemoji">'+w("shield")+"</span><h2>戦闘継続不能</h2><p>"+d(n.mon)+"にHPを削り切られてしまった。訓練場で復習してもう一度挑もう。</p>",l=e?'<span class="bigemoji">'+w("trophy")+"</span><h2>"+d(n.mon)+'を撃破した！</h2><div class="starsline">'+Se(a)+"</div><p>誤答"+r.wrong+"回で切り抜けた。単元「"+d(n.sub)+"」はもう怖くない。</p>":o,u=r.stageIndex+1,b=e&&u<D.length;return""+U()+'<div class="frame result">'+l+'<div class="resultbtns"><button class="ghost" id="btnReview">'+w("book")+' 訓練場で見直す</button><button class="ghost" id="btnRetry">'+(e?"もう一度挑む":"再挑戦する")+"</button>"+(b?'<button class="primary" id="btnNext">次の間へ進む →</button>':"")+'<button class="ghost" id="btnMap">地図へ戻る</button></div></div>'+(!b&&e&&u>=D.length?'<div class="frame allclear"><h2>'+w("trophy")+" 全"+D.length+'章 制覇</h2><p>期末試験の範囲をひと通り旅した。総獲得星 <span class="num">'+z()+" / "+q+"</span>。仕上げにもう一周して星を集めよう。</p></div>":"")}function C(){var e=document.getElementById("app");if(xn&&(xn(),xn=null),document.body.classList.toggle("case-map-screen",r.screen==="map"),r.screen==="map"){let p=function(){a&&(a.classList.add("is-scrolling"),clearTimeout(s),s=setTimeout(function(){a.classList.remove("is-scrolling")},120))};e.innerHTML=Ja(),Array.prototype.forEach.call(e.querySelectorAll(".stagecard:not(.locked)"),function(x){x.addEventListener("click",function(){if(!x.disabled){x.disabled=!0,x.classList.add("opening"),r.curQ=null;var m=parseInt(x.getAttribute("data-idx"),10);requestAnimationFrame(function(){t.settings.studyModeActive?kn(m):Le(m,!1)})}})});var n=document.getElementById("btnSoloCollapse");n&&n.addEventListener("click",function(){t.settings.soloCollapsed=!t.settings.soloCollapsed,H(t);var x=n.closest(".solo-momentum");x&&x.classList.toggle("collapsed",t.settings.soloCollapsed),n.textContent=t.settings.soloCollapsed?"＋":"−",n.setAttribute("aria-expanded",String(!t.settings.soloCollapsed)),n.setAttribute("aria-label",t.settings.soloCollapsed?"今日の一歩を展開":"今日の一歩を最小化")});var a=e.querySelector(".case-office"),i=e.querySelector(".case-scroll"),s=0;i&&i.addEventListener("scroll",p,{passive:!0}),window.addEventListener("scroll",p,{passive:!0}),xn=function(){clearTimeout(s),i&&i.removeEventListener("scroll",p),window.removeEventListener("scroll",p)},document.getElementById("btnModeToggle").addEventListener("click",function(){t.settings.studyModeActive=!t.settings.studyModeActive,H(t),C()});var o=document.getElementById("btnCodexOpen");o&&o.addEventListener("click",function(x){x.preventDefault(),Xt(e)}),document.getElementById("btnEndless").addEventListener("click",function(){Yn()}),document.getElementById("btnRanking").addEventListener("click",function(){r.curQ=null,r.screen="ranking",C()}),document.getElementById("btnEndlessDesk").addEventListener("click",function(){Yn()});var l=document.getElementById("btnEndlessResume");l&&l.addEventListener("click",function(){Yn()}),document.getElementById("btnAltToggle").addEventListener("click",function(){t.settings.allowAlt=!t.settings.allowAlt,H(t),this.classList.toggle("on",t.settings.allowAlt),this.setAttribute("aria-pressed",String(t.settings.allowAlt)),this.innerHTML='<span class="alt-file-label">'+w(t.settings.allowAlt?"unlock":"lock")+" 別解 "+(t.settings.allowAlt?"採用":"不採用")+'</span><span class="alt-switch" aria-hidden="true"><span class="alt-switch-knob"></span></span>'}),document.getElementById("btnUnitPicker").addEventListener("click",function(){fe()}),document.getElementById("btnReview2").addEventListener("click",function(){Kt()})}else if(r.screen==="ranking")e.innerHTML=Qe(),hn(e);else if(r.screen==="ranking-room")e.innerHTML=vn(),yn(e);else if(r.screen==="unitPicker")e.innerHTML=sn(),ln(e);else if(r.screen==="studyLoading")e.innerHTML=_n();else if(r.screen==="study")e.innerHTML=Bn(),An(e);else if(r.screen==="lesson")e.innerHTML=tn(),an(e);else if(r.screen==="battle")e.innerHTML=on(),document.getElementById("btnHome").addEventListener("click",function(){r.curQ=null,r.screen="map",C()}),document.getElementById("btnReview").addEventListener("click",function(){Le(r.stageIndex,!0)}),be(e);else if(r.screen==="endless")e.innerHTML=cn(),document.getElementById("btnHome").addEventListener("click",function(){r.curQ=null,r.screen="map",C()}),document.getElementById("btnEndlessFilter").addEventListener("click",function(){r.curQ=null,fe()}),document.getElementById("btnPauseEndless").addEventListener("click",function(){H(t),r.curQ=null,r.screen="map",C()}),be(e);else if(r.screen==="endless-result")e.innerHTML=dn(),document.getElementById("btnHome").addEventListener("click",function(){r.curQ=null,r.screen="map",C()}),document.getElementById("btnEndlessAgain").addEventListener("click",function(){r.curQ=null,$e(),r.screen="endless",C()}),document.getElementById("btnEndlessSettings").addEventListener("click",function(){r.curQ=null,fe()});else if(r.screen==="review"){e.innerHTML=er();var u=document.getElementById("btnHome");u&&u.addEventListener("click",function(){r.curQ=null,r.screen="map",C()});var b=document.getElementById("btnMap");b&&b.addEventListener("click",function(){r.curQ=null,r.screen="map",C()});var f=document.getElementById("btnReviewAgain");f&&f.addEventListener("click",function(){Kt()}),document.getElementById("qcard")&&be(e)}else if(r.screen==="result-win"||r.screen==="result-lose"){var y=r.screen==="result-win";e.innerHTML=nr(y);var g=document.getElementById("btnReview");g&&g.addEventListener("click",function(){r.curQ=null,Le(r.stageIndex,!1)});var P=document.getElementById("btnRetry");P&&P.addEventListener("click",function(){r.curQ=null,ye(r.stageIndex,r.startTier)});var E=document.getElementById("btnNext");E&&E.addEventListener("click",function(){r.curQ=null,ye(r.stageIndex+1,r.startTier)});var _=document.getElementById("btnMap");_&&_.addEventListener("click",function(){r.curQ=null,r.screen="map",C()})}}var Te=null,Gn=null;function tr(){return Te?Promise.resolve(Te):(Gn||(Gn=import("./chunk-studyBeats-2026072122.js").then(function(e){return Te=e.resolveStudyBeats,Te})),Gn)}function ar(e,n){var a=t.studyMedal[e];(!a||Rn[n]>Rn[a])&&(t.studyMedal[e]=n)}function rr(e){var n=d(e);return n=n.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>"),n=n.replace(/`(.+?)`/g,"<code>$1</code>"),n}function Zt(e){var n=String(e).split(/\n\s*\n/).map(function(s){return s.trim()}).filter(Boolean),a=[],i=null;return n.forEach(function(s){var o=s.match(/^##\s*(.+)$/);o?(i={heading:o[1].trim(),paras:[]},a.push(i)):(i||(i={heading:null,paras:[]},a.push(i)),i.paras.push("<p>"+rr(s)+"</p>"))}),a.map(function(s,o){var l=s.paras.join(""),u=!!(s.heading&&(s.heading.indexOf("罠")!==-1||s.heading.indexOf("注意")!==-1));if(o===0){var b=s.heading?"<h4"+(u?' class="trap"':"")+">"+d(s.heading)+"</h4>":"";return b+l}var f=s.heading?u?w("alert")+" タップして「"+d(s.heading)+"」を確認":w("book")+" タップして「"+d(s.heading)+"」を表示":w("book")+" タップして詳細を表示";return'<details class="accordion'+(u?" trap":"")+'"><summary>'+f+'<span class="chev">▸</span></summary><div class="accordion-body">'+l+"</div></details>"}).join("")}function ir(e,n){var a=d(e),i=n?d(n):"";return i&&a.indexOf(i)!==-1?a.split(i).join('<mark class="qhl">'+i+"</mark>"):a}async function kn(e){r.stageIndex=e,r.studyStep=0,r.studyPicked=null,r.studyCombo=0,r.studyBestCombo=0,r.studyWrongCount=0,r.screen="studyLoading",C();try{if(await tr(),r.screen!=="studyLoading")return;r.screen="study",C()}catch(n){if(console.error("学習データを読み込めませんでした",n),r.screen!=="studyLoading")return;r.screen="map",C(),window.alert("学習データを読み込めませんでした。通信を確認して、もう一度お試しください。")}}function _n(){return""+U()+'<div class="frame lessonintro"><h2>'+w("book")+" 学習資料を読み込んでいます…</h2><p>事件一覧の表示を軽くするため、詳しい解説は必要になった時だけ読み込みます。</p></div>"}function sr(e){t.studyCompleted[e.id]||(t.studyCompleted[e.id]=!0,H(t));var n=e.lesson.map(function(a,i){return'<div class="frame lessoncard"><div class="lstep">要点 '+(i+1)+" / "+e.lesson.length+"</div><h3>"+d(a.title)+'</h3><pre class="codeblock">'+d(a.code)+'</pre><p class="lessonexplain">'+d(a.explain)+"</p></div>"}).join("");return""+U()+'<div class="battlebar"><button class="backbtn" id="btnStudyBack">← 地図へ戻る</button><button class="togglebtn" id="btnStudyToggle">⇄ 問題パートに切替</button></div><div class="frame lessonintro"><h2>'+ie(e.id,e.isBoss)+" 学習ノート — "+d(e.title)+"</h2><p>"+d(e.sub)+'の要点を、完成した正しいコードと解説でひと通り確認しよう。この章はまだ物語形式の学習パートを準備中なので、訓練場と同じ要点ノートを学習パートとして表示している。</p></div><div class="lessongrid">'+n+'</div><div class="frame result"><span class="bigemoji">'+w("check")+'</span><h2>学習ノートを確認しました</h2><p>準備ができたら、問題パートで実際に手を動かして定着させよう。</p><div class="resultbtns"><button class="primary" id="btnStudyToChallenge">問題に挑戦する →</button><button class="ghost" id="btnStudyToMap">地図に戻る</button></div></div>'}function Bn(){var e=D[r.stageIndex],n=Te(e),a=n.length;if(a===0)return sr(e);if(r.studyStep>=a){t.studyCompleted[e.id]=!0;var i=r.studyWrongCount===0?"gold":r.studyWrongCount<=2?"silver":"bronze";ar(e.id,i),H(t);var s={gold:"ノーミス達成 — 完璧な理解です",silver:"好調な仕上がりです",bronze:"学習を修了しました"}[i];return""+U()+'<div class="battlebar"><button class="backbtn" id="btnStudyBack">← 地図へ戻る</button><button class="togglebtn" id="btnStudyToggle">⇄ 問題パートに切替</button></div><div class="frame result achieve '+i+'"><span class="bigemoji">'+w("trophy")+"</span><h2>"+s+"</h2><p>"+d(e.sub)+"の急所は仕込み終えた。この勢いのまま、"+d(e.mon)+'に挑んでみよう。</p><div class="achievestats"><span>誤答 <b>'+r.studyWrongCount+"</b>回</span><span>最高コンボ <b>"+r.studyBestCombo+'</b></span></div><div class="resultbtns"><button class="primary" id="btnStudyToChallenge">問題に挑戦する →</button><button class="ghost" id="btnStudyToMap">地図に戻る</button></div></div>'}var o=n[r.studyStep],l=r.studyPicked!==null,u=l&&r.studyPicked===o.quiz.correct,b=Math.round(r.studyStep/a*100),f=n.map(function(p,x){return'<span class="dot'+(x<r.studyStep?" done":"")+(x===r.studyStep?" cur":"")+'"></span>'}).join(""),y=u&&r.studyCombo>=2?'<div class="combobadge">'+w("spark")+" "+r.studyCombo+" COMBO</div>":"",g;if(l){var E=o.quiz.options[o.quiz.correct],_=!u&&o.quiz.sourceQuote?'<div class="guidance"><span class="glabel">'+w("book")+' 本文のここをもう一度確認しよう</span><p class="gquote">'+ir(o.quiz.sourceQuote,E)+"</p></div>":"";g='<div class="quizbox"><p class="quizq">'+w("chip")+" "+d(o.quiz.q)+"</p>"+y+'<div class="feedback '+(u?"good":"bad")+'"><div class="head">'+w(u?"check":"alert")+(u?" 正解":" 惜しい、正解は「"+d(E)+"」")+"</div>"+_+'<div class="explain sstory">'+Zt(o.quiz.explain)+'</div></div><div class="actionrow"><button class="primary" id="btnStudyNext">'+(r.studyStep+1<a?"次へ →":"仕上げる →")+"</button></div></div>"}else{var P=o.quiz.options.map(function(p,x){return'<button class="choicebtn studyquizbtn" data-opt="'+x+'">'+d(p)+"</button>"}).join("");g='<div class="quizbox"><p class="quizq">'+w("chip")+" "+d(o.quiz.q)+'</p><div class="choicegrid">'+P+"</div></div>"}return""+U()+'<div class="battlebar"><button class="backbtn" id="btnStudyBack">← 地図へ戻る</button><button class="togglebtn" id="btnStudyToggle">⇄ 問題パートに切替</button></div><div class="studyexpbar"><div class="studyexpfill" style="width:'+b+'%"></div></div><div class="studydots">'+f+'<span class="studystep">'+(r.studyStep+1)+" / "+a+'</span></div><div class="frame storycard"><span class="sicon">'+w("chip")+'</span><div class="sstory">'+Zt(o.story)+'</div><pre class="codeblock">'+d(o.code)+"</pre></div>"+g}function An(e){var n=document.getElementById("btnStudyBack");n&&n.addEventListener("click",function(){r.screen="map",C()});var a=document.getElementById("btnStudyToggle");a&&a.addEventListener("click",function(){Le(r.stageIndex,!1)});var i=document.getElementById("btnStudyNext");i&&i.addEventListener("click",function(){r.studyStep++,r.studyPicked=null,C()});var s=document.getElementById("btnStudyToChallenge");s&&s.addEventListener("click",function(){Le(r.stageIndex,!1)});var o=document.getElementById("btnStudyToMap");o&&o.addEventListener("click",function(){r.screen="map",C()}),Array.prototype.forEach.call(e.querySelectorAll(".studyquizbtn"),function(l){l.addEventListener("click",function(){var u=D[r.stageIndex],b=Te(u),f=b[r.studyStep],y=parseInt(l.getAttribute("data-opt"),10);r.studyPicked=y,Ae("studySteps",1),y===f.quiz.correct?(r.studyCombo++,r.studyCombo>r.studyBestCombo&&(r.studyBestCombo=r.studyCombo)):(r.studyCombo=0,r.studyWrongCount++),H(t),C()})})}var Jt=!1,Cn=null;function lr(e){return!!(e&&e.queue&&e.queue.length>0&&e.pos<e.queue.length)}function or(){Jt||(Ve(),Jt=!0)}function We(){return'<div class="topbar"><div class="brand"><span class="glyph">⬡</span><div><h1>コード事件捜査局</h1><small>CODE CASE BUREAU // EXAM INVESTIGATION</small></div></div><div class="tally">MISSION SCORE <span class="stars num">'+z()+" / "+q+"</span></div></div>"}function cr(){var e=N[W(t.settings.endlessUnits)]||"標準";return'<section class="codex-panel" aria-label="Codex Panel"><div class="codex-panel__header"><span class="codex-panel__eyebrow">NEW CODEX PANEL</span><h4>観測ログ</h4></div><div class="codex-panel__body"><p>新しい捜査窓口を展開しました。次の観測点をすぐ確認できます。</p><ul><li>未解決事件: '+F()+" 件</li><li>総合評価: "+z()+" / "+q+"</li><li>獲得バッジ: "+_e().filter(function(n){return n.earned}).length+" / "+_e().length+" 個</li><li>推奨難易度: "+d(e)+'</li></ul><button class="codex-panel__cta" id="btnCodexOpen" type="button">観測を開く</button></div></section>'}function dr(){var e=pe(),n=Ce(),a=!!t.settings.soloCollapsed,i=e.missions.map(function(o){var l=o.value>=o.target,u=Math.min(100,Math.round(o.value/o.target*100));return'<li class="'+(l?"done":"")+'"><span class="solo-check">'+(l?w("check"):"○")+"</span><div><b>"+d(o.label)+"</b><small>"+Math.min(o.value,o.target)+" / "+o.target+'</small><span class="solo-mini-bar"><i style="width:'+u+'%"></i></span></div></li>'}).join(""),s=n.next?"次の「"+n.next.name+"」まで "+(n.next.min-n.points)+" pt":"最高ランクに到達";return'<section class="solo-momentum'+(a?" collapsed":"")+'"><div class="solo-head"><div><small>SOLO INVESTIGATION</small><h3>今日の一歩</h3></div><div class="solo-head-actions"><span class="solo-streak">'+w("spark")+" "+e.streak+'日</span><button type="button" id="btnSoloCollapse" aria-expanded="'+!a+'" aria-label="'+(a?"今日の一歩を展開":"今日の一歩を最小化")+'">'+(a?"＋":"−")+'</button></div></div><div class="solo-content"><ul class="solo-missions">'+i+'</ul><div class="solo-rank"><span><small>現在の階級</small><b>'+d(n.name)+"</b></span><strong>"+n.points+' pt</strong></div><div class="solo-rank-bar"><i style="width:'+n.percent+'%"></i></div><p>'+d(s)+" ・ 1日最高 "+e.bestDayCorrect+"正解</p>"+(e.completed===3?'<div class="solo-complete">'+w("trophy")+" 本日の捜査目標を全達成！</div>":"")+"</div></section>"}function _e(){var e=[],n=z(),a=Object.keys(t.stars).filter(function(k){return(t.stars[k]||0)>0}).length,i=(t.endless.correct||0)+(t.endless.wrong||0),s=i>0?Math.round((t.endless.correct||0)/i*100):0,o=Object.keys(t.studyCompleted||{}).filter(function(k){return!!t.studyCompleted[k]}).length,l=Object.keys(t.studyMedal||{}).filter(function(k){return!!t.studyMedal[k]}).length,u=pe(),b=Object.keys(t.activity&&t.activity.days||{}).filter(function(k){var T=t.activity.days[k]||{};return(T.answers||0)+(T.studySteps||0)+(T.reviewsCleared||0)>0}).length,f=Object.keys(t.activity&&t.activity.days||{}).reduce(function(k,T){return k+((t.activity.days[T]||{}).reviewsCleared||0)},0),y=t.ranking&&Array.isArray(t.ranking.rooms)?t.ranking.rooms:[],g=y.reduce(function(k,T){return Math.max(k,(T.members||[]).length)},0),P=Ce().points,E=0;Object.keys(t.unitStats||{}).forEach(function(k){var T=t.unitStats[k]||{};(T.correct||0)>=5&&(T.wrong||0)===0&&E++});var _={初回突破:{how:"いずれかの事件でスターを1個以上獲得する",current:n,target:1,unit:"個"},序盤制圧:{how:"スターを合計3個獲得する",current:n,target:3,unit:"個"},中盤の切り札:{how:"スターを合計9個獲得する",current:n,target:9,unit:"個"},捜査の手応え:{how:"スターを合計15個獲得する",current:n,target:15,unit:"個"},上級捜査官:{how:"スターを合計20個獲得する",current:n,target:20,unit:"個"},伝説の実力者:{how:"スターを合計30個獲得する",current:n,target:30,unit:"個"},完全制覇:{how:"全事件で最大数のスターを集める",current:n,target:q,unit:"個"},半分の証拠:{how:"全事件の半分以上をクリアする",current:a,target:Math.ceil(D.length/2),unit:"章"},全章制覇:{how:"すべての事件を1回以上クリアする",current:a,target:D.length,unit:"章"},無傷の捜査:{how:"間違いノートを0件にする",current:F(),target:0,unit:"件",lowerIsBetter:!0},短期連勝:{how:"1000本ノックで3問連続正解する",current:t.endless.bestStreak||0,target:3,unit:"問"},連勝の極意:{how:"1000本ノックで8問連続正解する",current:t.endless.bestStreak||0,target:8,unit:"問"},連鎖突破:{how:"1000本ノックで15問連続正解する",current:t.endless.bestStreak||0,target:15,unit:"問"},"50本ノック達成":{how:"1000本ノックで累計50問に回答する",current:i,target:50,unit:"問"},"100本ノック達成":{how:"1000本ノックで累計100問に回答する",current:i,target:100,unit:"問"},"300本ノック達成":{how:"1000本ノックで累計300問に回答する",current:i,target:300,unit:"問"},"1000本ノック達成":{how:"1000本ノックで累計1000問に回答する",current:i,target:1e3,unit:"問"},高精度の捜査:{how:"1000本ノックを20問以上解き、正答率80%以上にする",current:s,target:80,unit:"%",note:"回答数 "+i+" / 20問"},正答率の鬼:{how:"1000本ノックを20問以上解き、正答率90%以上にする",current:s,target:90,unit:"%",note:"回答数 "+i+" / 20問"},学習ログ起動:{how:"学習パートを3章完了する",current:o,target:3,unit:"章"},学びの習慣:{how:"学習パートを6章完了する",current:o,target:6,unit:"章"},証拠を読み切る:{how:"学習パートを10章完了する",current:o,target:10,unit:"章"},学習モード:{how:"ホームで章選択の動作を「証拠を読む」に切り替える",current:t.settings.studyModeActive?1:0,target:1,unit:"回"},別解採用:{how:"ホームで「別解 採用」をオンにする",current:t.settings.allowAlt?1:0,target:1,unit:"回"},双方向攻略:{how:"学習モードと別解採用を両方オンにする",current:(t.settings.studyModeActive?1:0)+(t.settings.allowAlt?1:0),target:2,unit:"設定"},単元を極めた:{how:"同じ単元で5問以上正解し、誤答0を保つ",current:E,target:1,unit:"単元"},弱点を克服:{how:"3単元で5問以上正解し、誤答0を保つ",current:E,target:3,unit:"単元"},捜査条件を絞る:{how:"1000本ノックの対象単元を絞り込む",current:t.settings.endlessUnits&&t.settings.endlessUnits.length?1:0,target:1,unit:"設定"},難易度を見極める:{how:"1000本ノックの難易度を絞り込む",current:t.settings.endlessDiffs&&t.settings.endlessDiffs.length?1:0,target:1,unit:"設定"},重要度に着目:{how:"1000本ノックの重要度を絞り込む",current:t.settings.endlessTiers&&t.settings.endlessTiers.length?1:0,target:1,unit:"設定"},勉強の証:{how:"いずれかの学習パートを完了してメダルを獲得する",current:Object.keys(t.studyMedal||{}).length,target:1,unit:"個"},証拠収集家:{how:"学習メダルを5個集める",current:l,target:5,unit:"個"},資料室の主:{how:"学習メダルを10個集める",current:l,target:10,unit:"個"},現場百問:{how:"通常問題で累計100問正解する",current:Object.keys(t.unitStats||{}).reduce(function(k,T){return k+(t.unitStats[T].correct||0)},0),target:100,unit:"問"},復習捜査官:{how:"間違いノートの問題を5問解決する",current:f,target:5,unit:"問"},弱点封鎖:{how:"間違いノートの問題を20問解決する",current:f,target:20,unit:"問"},二日連続出動:{how:"2日連続で学習活動を記録する",current:u.streak,target:2,unit:"日"},一週間の張り込み:{how:"7日連続で学習活動を記録する",current:u.streak,target:7,unit:"日"},常連捜査員:{how:"合計30日で学習活動を記録する",current:b,target:30,unit:"日"},捜査会議を設置:{how:"ランキング部屋を1つ作成または参加する",current:y.length,target:1,unit:"室"},合同捜査:{how:"5人以上が登録されたランキング部屋に入る",current:g,target:5,unit:"人"},大規模捜査本部:{how:"10人以上が登録されたランキング部屋に入る",current:g,target:10,unit:"人"},名乗りを上げる:{how:"ユーザー名を「あなた」以外に変更する",current:t.ranking&&t.ranking.nickname&&t.ranking.nickname!=="あなた"?1:0,target:1,unit:"回"},事件解析官:{how:"捜査階級ポイントを300pt以上にする",current:P,target:300,unit:"pt"},首席コード探偵:{how:"捜査階級ポイントを1400pt以上にする",current:P,target:1400,unit:"pt"},まだ一歩目:{how:"最初の学習や事件捜査を始める前に与えられる記念バッジ",current:n+i+o===0?1:0,target:1,unit:"個"}};function p(k,T,de,se,Z){var G=!!Z,V=_[k]||{how:"条件を満たすと取得できます",current:G?1:0,target:1,unit:"回"};e.push({label:k,rarity:T||"common",tone:de||"neutral",batch:se||"base",earned:G,how:V.how,current:V.current,target:V.target,unit:V.unit||"",lowerIsBetter:!!V.lowerIsBetter,note:V.note||""})}var x={base:!0,standard:n>=9||a>=3||i>=50,advanced:n>=20||i>=200||o>=6,legendary:n>=q||i>=1e3||t.endless.bestStreak>=15};p("初回突破","common","good","base",n>0),p("序盤制圧","common","good","base",n>=3),p("中盤の切り札","common","good","standard",n>=9),p("捜査の手応え","rare","good","standard",n>=15),p("上級捜査官","rare","good","advanced",n>=20),p("伝説の実力者","epic","good","advanced",n>=30),p("完全制覇","legendary","good","legendary",n>=q),p("半分の証拠","common","good","standard",a>=Math.ceil(D.length/2)),p("全章制覇","rare","good","advanced",a>=D.length),p("無傷の捜査","rare","good","advanced",n>0&&F()===0),p("短期連勝","common","good","base",t.endless.bestStreak>=3),p("連勝の極意","rare","good","standard",t.endless.bestStreak>=8),p("連鎖突破","epic","good","legendary",t.endless.bestStreak>=15),p("50本ノック達成","common","good","standard",i>=50),p("100本ノック達成","rare","good","advanced",i>=100),p("300本ノック達成","epic","good","advanced",i>=300),p("1000本ノック達成","legendary","good","legendary",i>=1e3),p("高精度の捜査","rare","good","standard",s>=80&&i>=20),p("正答率の鬼","epic","good","advanced",s>=90&&i>=20),p("学習ログ起動","common","neutral","base",o>=3),p("学びの習慣","common","neutral","standard",o>=6),p("証拠を読み切る","rare","neutral","advanced",o>=10),p("学習モード","common","neutral","base",t.settings.studyModeActive),p("別解採用","common","neutral","base",t.settings.allowAlt),p("双方向攻略","rare","neutral","advanced",t.settings.studyModeActive&&t.settings.allowAlt),p("単元を極めた","rare","neutral","standard",E>=1),p("弱点を克服","epic","neutral","advanced",E>=3),p("捜査条件を絞る","common","neutral","base",!!(t.settings.endlessUnits&&t.settings.endlessUnits.length)),p("難易度を見極める","common","neutral","standard",!!(t.settings.endlessDiffs&&t.settings.endlessDiffs.length)),p("重要度に着目","rare","neutral","advanced",!!(t.settings.endlessTiers&&t.settings.endlessTiers.length)),p("勉強の証","common","neutral","base",!!Object.keys(t.studyMedal||{}).some(function(k){return!!t.studyMedal[k]})),p("証拠収集家","rare","neutral","study",l>=5),p("資料室の主","epic","neutral","study",l>=10),p("現場百問","rare","good","case",_.現場百問.current>=100),p("復習捜査官","rare","good","case",f>=5),p("弱点封鎖","epic","good","case",f>=20),p("二日連続出動","common","neutral","special",u.streak>=2),p("一週間の張り込み","epic","neutral","special",u.streak>=7),p("常連捜査員","legendary","neutral","special",b>=30),p("捜査会議を設置","common","good","league",y.length>=1),p("合同捜査","rare","good","league",g>=5),p("大規模捜査本部","epic","good","league",g>=10),p("名乗りを上げる","common","neutral","league",!!(t.ranking&&t.ranking.nickname&&t.ranking.nickname!=="あなた")),p("事件解析官","rare","good","special",P>=300),p("首席コード探偵","legendary","good","special",P>=1400),p("まだ一歩目","common","neutral","base",n===0&&i===0&&o===0);var m=["初回突破","序盤制圧","中盤の切り札","捜査の手応え","上級捜査官","伝説の実力者","完全制覇","半分の証拠","全章制覇","無傷の捜査","単元を極めた","弱点を克服"],A=["学習ログ起動","学びの習慣","証拠を読み切る","学習モード","勉強の証","証拠収集家","資料室の主"],B=["短期連勝","連勝の極意","連鎖突破","50本ノック達成","100本ノック達成","300本ノック達成","1000本ノック達成","高精度の捜査","正答率の鬼","捜査条件を絞る","難易度を見極める","重要度に着目"],M=["捜査会議を設置","合同捜査","大規模捜査本部","名乗りを上げる"];e.forEach(function(k){m.indexOf(k.label)!==-1?k.batch="case":A.indexOf(k.label)!==-1?k.batch="study":B.indexOf(k.label)!==-1?k.batch="training":M.indexOf(k.label)!==-1?k.batch="league":k.batch="special"});var O=typeof window<"u"&&new URLSearchParams(window.location.search).get("demo")==="all";return O&&e.forEach(function(k){k.earned=!0,k.note="全取得デモ表示"}),e}function ur(){var e=Object.keys(t.stars).filter(function(a){return(t.stars[a]||0)>0}).length,n=_e().map(function(a){return a.label}).join(" / ");return`コード事件捜査局 進捗状況
ユーザー名: `+(t.ranking.nickname||"あなた")+`
総合評価: `+z()+" / "+q+`
解決済みケース: `+e+" / "+D.length+`
実績: `+n}function Sn(){return(!t.showcase||typeof t.showcase!="object")&&(t.showcase={achievementLabels:null}),t.showcase}function pr(){var e=Object.keys(t.stars).filter(function(f){return(t.stars[f]||0)>0}).length,n=t.ranking.nickname||"あなた",a=_e(),i=a.filter(function(f){return f.earned}).length,s=Sn();if(!Array.isArray(s.achievementLabels)||s.achievementLabels.length!==5){for(var o=a.filter(function(f){return f.earned}).slice(0,5).map(function(f){return f.label});o.length<5;)o.push(null);s.achievementLabels=o,H(t)}var l=s.achievementLabels.map(function(f,y){var g=a.filter(function(E){return E.label===f&&E.earned})[0];if(!g)return'<li class="codex-showcase__achievement empty" data-showcase-slot="'+y+'"><span>実績をここへドロップ</span></li>';var P="codex-showcase__achievement--"+(g.rarity||"common");return'<li class="codex-showcase__achievement '+g.tone+" "+P+'" data-showcase-slot="'+y+'" draggable="true" data-achievement-label="'+d(g.label)+'"><span>'+d(g.label)+'</span><button type="button" data-clear-showcase="'+y+'" aria-label="'+d(g.label)+'を外す">×</button></li>'}).join(""),u=a.filter(function(f){return f.earned}).map(function(f){return'<button type="button" class="codex-showcase__source '+f.tone+" codex-showcase__source--"+(f.rarity||"common")+'" draggable="true" data-showcase-source="'+d(f.label)+'"><span>'+d(f.label)+"</span></button>"}).join(""),b=z()>=q?"全事件を完全制覇":e===0?"最初の事件を捜査中":"全"+D.length+"件中 "+e+"件を解決済み";return'<div class="codex-showcase" id="codexShowcase"><div class="codex-showcase__header"><span class="codex-showcase__eyebrow">PROGRESS STATUS</span><h6>進捗状況</h6></div><div class="codex-showcase__body"><label class="codex-showcase__identity"><span>ユーザー名</span><input id="showcaseUsername" maxlength="16" value="'+d(n)+'"></label><div class="codex-showcase__hero"><div class="codex-showcase__stamp">★ '+z()+" / "+q+'</div><div class="codex-showcase__quote">'+d(b)+'</div></div><div class="codex-showcase__metrics"><div class="codex-showcase__metric"><span>解決済みケース</span><strong>'+e+" / "+D.length+'</strong></div><div class="codex-showcase__metric"><span>未解決イベント</span><strong>'+F()+' 件</strong></div><div class="codex-showcase__metric"><span>推奨難易度</span><strong>'+d(N[W(t.settings.endlessUnits)]||"標準")+'</strong></div><div class="codex-showcase__metric"><span>獲得バッジ</span><strong>'+i+" / "+a.length+'</strong></div></div><div class="codex-showcase__achievement-head"><span>表示する実績</span><small>下の実績から5枠へドラッグ</small></div><div class="codex-showcase__tray" aria-label="取得済み実績">'+u+'</div><ul class="codex-showcase__achievements">'+l+"</ul></div></div>"}function fr(e){var n=e.querySelector("#codexShowcase");if(!n)return;var a=document.createElement("canvas"),i=1200,s=630,o=window.devicePixelRatio||1;a.width=i*o,a.height=s*o;var l=a.getContext("2d");l.scale(o,o);function u(x,m,A,B,M){if(l.roundRect){l.roundRect(x,m,A,B,M);return}l.beginPath(),l.moveTo(x+M,m),l.arcTo(x+A,m,x+A,m+B,M),l.arcTo(x+A,m+B,x,m+B,M),l.arcTo(x,m+B,x,m,M),l.arcTo(x,m,x+A,m,M),l.closePath()}var b=l.createLinearGradient(0,0,i,s);b.addColorStop(0,"#241a13"),b.addColorStop(1,"#5a2b20"),l.fillStyle=b,l.fillRect(0,0,i,s),l.fillStyle="rgba(255,255,255,0.08)";for(var f=0;f<12;f++)l.beginPath(),l.arc(70+f%6*210,110+Math.floor(f/6)*360,58,0,Math.PI*2),l.fill();l.save(),l.translate(40,40),l.fillStyle="#f3e4bc",u(0,0,i-80,s-80,34),l.fill(),l.lineWidth=3,l.strokeStyle="#b78d4d",l.stroke(),l.restore(),l.fillStyle="#8d302b",l.font='bold 25px "Hiragino Mincho ProN", serif',l.fillText("コード事件捜査局",80,98),l.fillStyle="#2b2318",l.font='700 46px "Hiragino Mincho ProN", serif',l.fillText("進捗状況",80,155),l.fillStyle="#6b5b3e",l.font='600 23px "Hiragino Kaku Gothic ProN", sans-serif',l.fillText("ユーザー名  "+(t.ranking.nickname||"あなた"),80,205),l.fillText("総合評価  "+z()+" / "+q,80,270),l.fillText("解決済み案件  "+Object.keys(t.stars).filter(function(x){return(t.stars[x]||0)>0}).length+" / "+D.length,80,320),l.fillText("未解決イベント  "+F()+" 件",80,370),l.fillText("推奨難易度  "+(N[W(t.settings.endlessUnits)]||"標準"),80,420);var y=_e();l.fillText("獲得バッジ  "+y.filter(function(x){return x.earned}).length+" / "+y.length,80,470),l.fillStyle="#4f3b24",l.font='700 25px "Hiragino Kaku Gothic ProN", sans-serif',l.fillText("選択した実績",685,145);var g=_e(),P=Sn(),E=Array.isArray(P.achievementLabels)?P.achievementLabels:[],_=E.map(function(x){return g.filter(function(m){return m.label===x&&m.earned})[0]}).filter(Boolean).slice(0,5);_.forEach(function(x,m){var A=205+m*64;l.fillStyle=x.tone==="good"?"#8d302b":"#3f6a8a",l.fillRect(685,A-18,15,15),l.fillStyle="#2b2318",l.font='600 22px "Hiragino Kaku Gothic ProN", sans-serif',l.fillText(x.label,720,A)}),l.fillStyle="#6b5b3e",l.font='600 18px "Hiragino Kaku Gothic ProN", sans-serif',l.fillText("CODE CASE BUREAU // PROGRESS CARD",80,545);var p=document.createElement("a");p.download="コード事件捜査局_進捗.png",p.href=a.toDataURL("image/png"),p.click()}function ea(e){if(!e)return;var n=e.querySelector(".codex-overlay");n&&n.remove();var a=Object.keys(t.stars).filter(function(c){return(t.stars[c]||0)>0}).length,i=[],s=_e();s.forEach(function(c,v){c.detailIndex=v});var o=0,l={case:"事件捜査",study:"学習記録",training:"連続演習",league:"ランキング",special:"特別捜査"},u=["common","rare","epic","legendary"],b={common:"一般バッジ",rare:"希少バッジ",epic:"稀バッジ",legendary:"伝説バッジ"},f=["case","study","training","league","special"];u.forEach(function(c){var v=s.filter(function(L){return(L.rarity||"common")===c});v.sort(function(L,ge){return f.indexOf(L.batch)-f.indexOf(ge.batch)});for(var h=0;h<v.length;h+=6){var S=v.slice(h,h+6),I="■ "+b[c]+(v.length>6?" "+(Math.floor(h/6)+1):""),R='<ul class="codex-achievements codex-achievement-page" data-achievement-page="'+o+'"'+(o?" hidden":"")+'><li class="codex-achievement-group">'+d(I)+"</li>";S.forEach(function(L){var ge=L.rarity==="legendary"?"【伝説】":L.rarity==="epic"?"【稀】":L.rarity==="rare"?"【希少】":"【一般】",En=L.earned?"codex-achievement--earned":"codex-achievement--locked",Pn=L.earned?' draggable="true" data-achievement-label="'+d(L.label)+'"':' aria-disabled="true"';R+='<li><button type="button" class="codex-achievement '+L.tone+" codex-achievement--"+(L.rarity||"common")+" "+En+'" data-achievement-index="'+L.detailIndex+'"'+Pn+"><span>"+d(ge)+" "+d(L.label)+'</span><span class="codex-achievement__batch">'+d(l[L.batch]||"特別捜査")+" · "+d(L.earned?"取得済み":"未取得")+" ›</span></button></li>"}),i.push(R+"</ul>"),o++}}),i=i.join("");var y=ur(),g=pr(),P='<div class="codex-overlay" role="dialog" aria-modal="true" aria-label="進捗と実績"><div class="codex-sheet"><button class="codex-sheet__close" id="btnCodexClose" type="button" aria-label="閉じる">×</button><div class="codex-sheet__header"><span class="codex-panel__eyebrow">SHAREABLE PROGRESS</span><h4>進捗と実績</h4></div><div class="codex-sheet__grid"><section class="codex-card"><h5>進捗</h5><ul class="codex-metrics"><li><span>総合評価</span><strong>'+z()+" / "+q+"</strong></li><li><span>解決済みケース</span><strong>"+a+" / "+D.length+"</strong></li><li><span>未解決イベント</span><strong>"+F()+" 件</strong></li><li><span>推奨難易度</span><strong>"+d(N[W(t.settings.endlessUnits)]||"標準")+"</strong></li><li><span>獲得バッジ</span><strong>"+s.filter(function(c){return c.earned}).length+" / "+s.length+' 個</strong></li></ul></section><section class="codex-card"><h5>実績</h5><div class="codex-achievement-pages">'+i+'</div><div class="codex-achievement-pager"><button type="button" id="btnAchievementPrev" aria-label="前の実績ページ">← 前へ</button><span id="achievementPageStatus">1 / '+o+'</span><button type="button" id="btnAchievementNext" aria-label="次の実績ページ">次へ →</button></div></section></div><div class="codex-share"><p class="codex-share__label">進捗状況プレビュー</p><div class="codex-share__preview">'+g+'</div><p class="codex-share__label">共有メッセージ</p><textarea class="codex-share__textarea" readonly>'+d(y)+'</textarea><div class="codex-share__actions"><button class="codex-panel__cta" id="btnSaveCodexPhoto" type="button">写真にする</button><button class="codex-panel__cta" id="btnCopyCodexShare" type="button">コピーする</button><button class="codex-panel__secondary" id="btnShareCodex" type="button">共有する</button></div></div></div><div class="codex-achievement-popover" id="achievementPopover" role="tooltip" hidden></div></div>';e.insertAdjacentHTML("beforeend",P);var E=e.querySelector(".codex-sheet");E&&E.addEventListener("click",function(c){c.stopPropagation()});function _(){var c=E?E.scrollTop:0,v=window.scrollX,h=window.scrollY;ea(e);var S=e.querySelector(".codex-sheet");S&&(S.scrollTop=c),window.scrollTo(v,h),requestAnimationFrame(function(){var I=e.querySelector(".codex-sheet");I&&(I.scrollTop=c),window.scrollTo(v,h)})}var p=e.querySelector(".codex-overlay");p&&p.addEventListener("click",function(){p.remove()});var x=e.querySelector("#btnCodexClose");x&&x.addEventListener("click",function(){p.remove()});var m=e.querySelector("#achievementPopover"),A=0,B=e.querySelectorAll("[data-achievement-page]"),M=e.querySelector("#achievementPageStatus"),O=e.querySelector("#btnAchievementPrev"),k=e.querySelector("#btnAchievementNext");function T(c){A=Math.max(0,Math.min(B.length-1,c)),Array.prototype.forEach.call(B,function(v,h){v.hidden=h!==A}),M&&(M.textContent=A+1+" / "+B.length),O&&(O.disabled=A===0),k&&(k.disabled=A===B.length-1),m&&(m.hidden=!0)}O&&O.addEventListener("click",function(){T(A-1)}),k&&k.addEventListener("click",function(){T(A+1)}),T(0);function de(c){var v;c.earned?v="条件達成済み":c.lowerIsBetter?v="あと "+Math.max(0,c.current-c.target)+" "+c.unit+"減らす":v="あと "+Math.max(0,c.target-c.current)+" "+c.unit;var h=c.current+" "+c.unit+" / 目標 "+c.target+" "+c.unit;return'<span class="codex-achievement-detail__eyebrow">'+d(c.earned?"UNLOCKED":"HOW TO UNLOCK")+"</span><b>"+d(c.label)+"</b><p>"+d(c.how)+'</p><div class="codex-achievement-detail__progress"><span>'+d(h)+"</span><strong>"+d(v)+"</strong></div>"+(c.note?"<small>"+d(c.note)+"</small>":"")}function se(c,v){if(m){var h=14,S=m.offsetWidth||280,I=m.offsetHeight||150,R=c+h,L=v+8;R+S>window.innerWidth-10&&(R=Math.max(10,c-S-h)),L+I>window.innerHeight-10&&(L=Math.max(10,window.innerHeight-I-10)),m.style.left=R+"px",m.style.top=L+"px"}}function Z(c,v,h,S){if(!(!m||!v)){if(m.innerHTML=de(v),m.hidden=!1,Array.prototype.forEach.call(e.querySelectorAll("[data-achievement-index]"),function(R){R.classList.remove("selected")}),c.classList.add("selected"),typeof h!="number"){var I=c.getBoundingClientRect();h=I.right,S=I.top}se(h,S)}}function G(c){m&&(m.hidden=!0),c&&c.classList.remove("selected")}var V=null;function J(c){V=c,Array.prototype.forEach.call(e.querySelectorAll("[data-achievement-index]"),function(v){v.classList.toggle("picked",v.getAttribute("data-achievement-label")===c)}),Array.prototype.forEach.call(e.querySelectorAll("[data-showcase-source]"),function(v){v.classList.toggle("picked",v.getAttribute("data-showcase-source")===c)})}function Me(c,v){var h=s.some(function(R){return R.earned&&R.label===v});if(h){for(var S=Sn(),I=Array.isArray(S.achievementLabels)?S.achievementLabels.slice(0,5):[null,null,null,null,null];I.length<5;)I.push(null);I=I.map(function(R,L){return R===v&&L!==c?null:R}),I[c]=v,S.achievementLabels=I,H(t),_()}}Array.prototype.forEach.call(e.querySelectorAll("[data-achievement-index]"),function(c){var v=s[parseInt(c.getAttribute("data-achievement-index"),10)];v.earned&&c.addEventListener("dragstart",function(h){J(v.label),h.dataTransfer&&(h.dataTransfer.effectAllowed="move",h.dataTransfer.setData("text/plain",v.label))}),c.addEventListener("pointerenter",function(h){h.pointerType!=="touch"&&Z(c,v,h.clientX,h.clientY)}),c.addEventListener("pointermove",function(h){h.pointerType!=="touch"&&m&&!m.hidden&&se(h.clientX,h.clientY)}),c.addEventListener("pointerleave",function(h){h.pointerType!=="touch"&&G(c)}),c.addEventListener("focus",function(){Z(c,v)}),c.addEventListener("blur",function(){G(c)}),c.addEventListener("click",function(h){v.earned&&J(v.label),(h.pointerType==="touch"||!window.matchMedia("(hover:hover)").matches)&&(m&&!m.hidden&&c.classList.contains("selected")?G(c):Z(c,v,h.clientX||void 0,h.clientY||void 0))})}),Array.prototype.forEach.call(e.querySelectorAll("[data-showcase-source]"),function(c){var v=c.getAttribute("data-showcase-source");c.addEventListener("dragstart",function(h){J(v),h.dataTransfer&&(h.dataTransfer.effectAllowed="copy",h.dataTransfer.setData("text/plain",v))}),c.addEventListener("click",function(){J(v)})}),Array.prototype.forEach.call(e.querySelectorAll("[data-showcase-slot]"),function(c){var v=parseInt(c.getAttribute("data-showcase-slot"),10),h=c.getAttribute("data-achievement-label");h&&c.addEventListener("dragstart",function(S){J(h),S.dataTransfer&&(S.dataTransfer.effectAllowed="move",S.dataTransfer.setData("text/plain",h))}),c.addEventListener("dragover",function(S){S.preventDefault(),c.classList.add("dragover"),S.dataTransfer&&(S.dataTransfer.dropEffect="move")}),c.addEventListener("dragleave",function(){c.classList.remove("dragover")}),c.addEventListener("drop",function(S){S.preventDefault(),c.classList.remove("dragover");var I=S.dataTransfer?S.dataTransfer.getData("text/plain"):V;I&&Me(v,I)}),c.addEventListener("click",function(S){S.target.closest("[data-clear-showcase]")||V&&Me(v,V)})}),Array.prototype.forEach.call(e.querySelectorAll("[data-clear-showcase]"),function(c){c.addEventListener("click",function(v){v.stopPropagation();var h=parseInt(c.getAttribute("data-clear-showcase"),10),S=Sn(),I=Array.isArray(S.achievementLabels)?S.achievementLabels.slice(0,5):[null,null,null,null,null];I[h]=null,S.achievementLabels=I,H(t),_()})});var le=e.querySelector("#showcaseUsername");le&&(le.addEventListener("click",function(c){c.stopPropagation()}),le.addEventListener("change",function(){we(le.value),_()}));var oe=e.querySelector("#btnCopyCodexShare");oe&&oe.addEventListener("click",function(){navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(y).then(function(){oe.textContent="コピー済み"}):oe.textContent="コピーできません"});var me=e.querySelector("#btnShareCodex");me&&me.addEventListener("click",function(){navigator.share?navigator.share({title:"コード事件捜査局 進捗",text:y}).catch(function(){}):navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(y).then(function(){me.textContent="共有文をコピー"})});var $=e.querySelector("#btnSaveCodexPhoto");$&&$.addEventListener("click",function(){fr(e),$.textContent="保存しました",setTimeout(function(){$&&($.textContent="写真にする")},1400)})}var br=["第1部 C++入門 ― 入出力・ポインタ・関数","第2部 データ構造 ― 配列・文字列・構造体","第3部 クラス設計 ― 基本から後片付けまで","第4部 継承と多態性","第5部 Pythonへの転生 ― クラスとTkinter"];function mr(){var e=!!t.settings.studyModeActive,n="",a=0,i=[];function s(){i.length&&(n+='<h3 class="groupheading">'+d(br[a]||"第"+(a+1)+"部")+'</h3><div class="stagegrid'+(e?" study-mode":"")+'">'+i.join("")+"</div>",i=[])}D.forEach(function(_,p){var x=t.stars[_.id]||0,m=!!t.studyCompleted[_.id],A=t.studyMedal[_.id],B=m?'<span class="studydonebadge">'+w(A?"trophy":"check")+" 学習済み</span>":e?'<span class="studyhint">'+w("book")+" 学習パートへ</span>":"";i.push('<button class="stagecard'+(_.isBoss?" boss":"")+'" data-idx="'+p+'" aria-label="'+d(_.title)+'"><div class="row1"><span class="emoji">'+ie(_.id,_.isBoss)+'</span><span class="idx">'+(_.isBoss?"BOSS NODE":"NODE "+String(p+1).padStart(2,"0"))+"</span></div><h3>"+d(_.title)+'</h3><div class="sub">'+d(_.sub)+" ・ "+d(_.mon)+"</div>"+B+'<div class="stars">'+Se(x)+"</div></button>"),_.isBoss&&(s(),a++)}),s();var o=t.endless,l=o.correct+o.wrong,u=l>0?Math.round(o.correct/l*100):0,b=t.settings.endlessUnits,f=t.settings.endlessDiffs,y=t.settings.endlessTiers,g=!b||b.length===0?"対象: 全"+Q.length+"単元":"対象: "+b.length+"/"+Q.length+"単元に絞り込み中";g+=!f||f.length===0?" ・ 難易度: 全て":" ・ 難易度: "+f.map(function(_){return N[_]}).join("/"),g+=!y||y.length===0?" ・ 重要度: 全て":" ・ 重要度: "+y.map(function(_){return ae[_]}).join("/");var P=W(b),E=F();return""+We()+'<main class="case-office"><aside class="case-sidebar"><div class="office-plate"><span>'+w("target")+'</span><div><small>BUG INVESTIGATION UNIT</small><h2>事件管理簿</h2></div></div><button class="case-nav active"><span>'+w("archive")+"</span><b>事件一覧</b><small>"+D.length+'件</small></button><button class="case-nav league-nav" id="btnRanking"><span>'+w("trophy")+'</span><b>ランキング</b><small>ルームで競う</small></button><button class="case-nav" id="btnEndless"><span>'+w("terminal")+'</span><b>総合捜査</b><small>1000本ノック</small></button><button class="case-nav" id="btnReview2"><span>'+w("review")+"</span><b>未解決</b><small>"+E+'件</small></button><button class="case-nav" id="btnUnitPicker"><span>'+w("target")+"</span><b>捜査条件</b><small>"+d(N[P])+'</small></button><div class="case-stats"><h3>捜査記録</h3><dl><div><dt>解決評価</dt><dd class="num">'+z()+" / "+q+'</dd></div><div><dt>連続正解</dt><dd class="num">'+o.streak+'</dd></div><div><dt>正答率</dt><dd class="num">'+u+'%</dd></div></dl></div><button class="mode-file '+(e?"study":"quest")+'" id="btnModeToggle" aria-pressed="'+(e?"true":"false")+'"><span>'+w(e?"book":"sword")+"</span><b>"+(e?"証拠を読む":"推理に挑む")+'</b><small>章選択時の動作</small></button><button class="alt-file'+(t.settings.allowAlt?" on":"")+'" id="btnAltToggle" aria-pressed="'+(t.settings.allowAlt?"true":"false")+'"><span class="alt-file-label">'+w(t.settings.allowAlt?"unlock":"lock")+" 別解 "+(t.settings.allowAlt?"採用":"不採用")+'</span><span class="alt-switch" aria-hidden="true"><span class="alt-switch-knob"></span></span></button></aside><section class="evidence-board"><header class="board-head"><div><small>ACTIVE CASE FILES</small><h2>プログラム事件一覧</h2></div><p>不具合の証拠を読み、すべての事件を解決せよ。</p></header>'+dr()+'<div class="case-scroll">'+n+'</div></section><aside class="desk-evidence"><div class="desk-lamp">'+w("search")+"</div><h3>本日の捜査</h3><p>"+d(g)+"</p><dl><div><dt>連続解決</dt><dd>"+o.streak+"</dd></div><div><dt>最高記録</dt><dd>"+o.bestStreak+"</dd></div></dl>"+(lr(o)?'<button id="btnEndlessResume" class="resume-file">'+w("review")+" 前回の捜査を再開("+(o.queue.length-o.pos)+"問残り)</button>":"")+'<button id="btnEndlessDesk">捜査を開始</button>'+cr()+'</aside></main><p class="footer-note">捜査記録はこの端末に自動保存されます。</p>'}function Kn(e,n){r.stageIndex=e,r.screen="lesson",r.lessonFromBattle=!!n,Y()}function Xn(){Je(),r.curQ=null,r.locked=!1,r.screen="endless",Y()}function $t(){var e=Object.keys(t.missed);r.reviewQueue=en(e.map(function(n){return qe[n]}).filter(function(n){return n!==void 0})),r.reviewPos=0,r.reviewStats={correct:0,wrong:0},r.curQ=null,r.locked=!1,r.screen="review",Y()}function gr(){var e=r.reviewQueue[r.reviewPos];return j[e]}function vr(){if(r.reviewQueue.length===0)return""+We()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button></div><div class="frame result"><span class="bigemoji">'+w("check")+'</span><h2>間違いノートは空っぽです</h2><p>今のところ間違えた問題は記録されていません。各章の戦闘や1000本ノックで間違えると、その問題が自動的にここへ集まってきます。</p><div class="resultbtns"><button class="ghost" id="btnMap">地図へ戻る</button></div></div>';if(r.reviewPos>=r.reviewQueue.length){var e=F();return""+We()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button></div><div class="frame result"><span class="bigemoji">'+w("review")+"</span><h2>この周の復習が終わりました</h2><p>正解 "+r.reviewStats.correct+"問 ／ 誤答 "+r.reviewStats.wrong+"問。間違いノートには、まだ"+e+'問残っています。</p><div class="resultbtns">'+(e>0?'<button class="primary" id="btnReviewAgain">もう一度復習する →</button>':"")+'<button class="ghost" id="btnMap">地図へ戻る</button></div></div>'}if(!r.curQ){var n=gr();r.curQ=n.q,r.endlessSrc=n}var a=Ee(r.curQ);return""+We()+'<div class="battlebar"><button class="backbtn" id="btnHome">← 地図へ戻る</button></div><div class="frame endlessbar"><div class="estat"><span class="elabel">出題元</span><span class="evalue">'+d(r.endlessSrc.srcTitle)+'</span></div><div class="estat"><span class="elabel">この周の進捗</span><span class="evalue">'+(r.reviewPos+1)+" / "+r.reviewQueue.length+'</span></div><div class="estat"><span class="elabel">間違いノート残り</span><span class="evalue">'+F()+'問</span></div></div><div class="frame qcard" id="qcard"><div class="qmeta"><span>'+w("review")+' 復習モード <span class="tierbadge t'+r.endlessSrc.tier+'">'+d(ae[r.endlessSrc.tier])+"</span></span><span>"+d(r.endlessSrc.srcSub)+'</span></div><div class="qlead">'+a.qlead+"</div>"+a.bodyHtml+a.answerHtml+'</div><div id="feedbackSlot"></div>'}function hr(e){var n=D[r.stageIndex],a=1;if(e){var i=r.heroHP/100;r.wrong===0?a=3:i>=.5?a=2:a=1;var s=t.stars[n.id]||0;a>s&&(t.stars[n.id]=a),r.stageIndex+2>t.unlocked&&(t.unlocked=r.stageIndex+2),t.unlocked>D.length&&(t.unlocked=D.length),H(t)}var o=r.failReason==="outofq"?'<span class="bigemoji">'+w("alert")+"</span><h2>ミッション未完了</h2><p>設問はすべて解き終えたが、"+d(n.mon)+"にはまだ息がある。誤答が多いと決定打が足りない。訓練場で復習してもう一度挑もう。</p>":'<span class="bigemoji">'+w("shield")+"</span><h2>戦闘継続不能</h2><p>"+d(n.mon)+"にHPを削り切られてしまった。訓練場で復習してもう一度挑もう。</p>",l=e?'<span class="bigemoji">'+w("trophy")+"</span><h2>"+d(n.mon)+'を撃破した！</h2><div class="starsline">'+Se(a)+"</div><p>誤答"+r.wrong+"回で切り抜けた。単元「"+d(n.sub)+"」はもう怖くない。</p>":o,u=r.stageIndex+1,b=e&&u<D.length;return""+We()+'<div class="frame result">'+l+'<div class="resultbtns"><button class="ghost" id="btnReview">'+w("book")+' 訓練場で見直す</button><button class="ghost" id="btnRetry">'+(e?"もう一度挑む":"再挑戦する")+"</button>"+(b?'<button class="primary" id="btnNext">次の間へ進む →</button>':"")+'<button class="ghost" id="btnMap">地図へ戻る</button></div></div>'+(!b&&e&&u>=D.length?'<div class="frame allclear"><h2>'+w("trophy")+" 全"+D.length+'章 制覇</h2><p>期末試験の範囲をひと通り旅した。総獲得星 <span class="num">'+z()+" / "+q+"</span>。仕上げにもう一周して星を集めよう。</p></div>":"")}function Y(){var e=document.getElementById("app");if(Cn&&(Cn(),Cn=null),document.body.classList.toggle("case-map-screen",r.screen==="map"),r.screen==="map"){let p=function(){a&&(a.classList.add("is-scrolling"),clearTimeout(s),s=setTimeout(function(){a.classList.remove("is-scrolling")},120))};e.innerHTML=mr(),Array.prototype.forEach.call(e.querySelectorAll(".stagecard:not(.locked)"),function(x){x.addEventListener("click",function(){if(!x.disabled){x.disabled=!0,x.classList.add("opening"),r.curQ=null;var m=parseInt(x.getAttribute("data-idx"),10);requestAnimationFrame(function(){t.settings.studyModeActive?kn(m):Kn(m,!1)})}})});var n=document.getElementById("btnSoloCollapse");n&&n.addEventListener("click",function(){t.settings.soloCollapsed=!t.settings.soloCollapsed,H(t);var x=n.closest(".solo-momentum");x&&x.classList.toggle("collapsed",t.settings.soloCollapsed),n.textContent=t.settings.soloCollapsed?"＋":"−",n.setAttribute("aria-expanded",String(!t.settings.soloCollapsed)),n.setAttribute("aria-label",t.settings.soloCollapsed?"今日の一歩を展開":"今日の一歩を最小化")});var a=e.querySelector(".case-office"),i=e.querySelector(".case-scroll"),s=0;i&&i.addEventListener("scroll",p,{passive:!0}),window.addEventListener("scroll",p,{passive:!0}),Cn=function(){clearTimeout(s),i&&i.removeEventListener("scroll",p),window.removeEventListener("scroll",p)},document.getElementById("btnModeToggle").addEventListener("click",function(){t.settings.studyModeActive=!t.settings.studyModeActive,H(t),Y()});var o=document.getElementById("btnCodexOpen");o&&o.addEventListener("click",function(x){x.preventDefault(),ea(e)}),document.getElementById("btnEndless").addEventListener("click",function(){Xn()}),document.getElementById("btnRanking").addEventListener("click",function(){r.curQ=null,r.screen="ranking",Y()}),document.getElementById("btnEndlessDesk").addEventListener("click",function(){Xn()});var l=document.getElementById("btnEndlessResume");l&&l.addEventListener("click",function(){Xn()}),document.getElementById("btnAltToggle").addEventListener("click",function(){t.settings.allowAlt=!t.settings.allowAlt,H(t),this.classList.toggle("on",t.settings.allowAlt),this.setAttribute("aria-pressed",String(t.settings.allowAlt)),this.innerHTML='<span class="alt-file-label">'+w(t.settings.allowAlt?"unlock":"lock")+" 別解 "+(t.settings.allowAlt?"採用":"不採用")+'</span><span class="alt-switch" aria-hidden="true"><span class="alt-switch-knob"></span></span>'}),document.getElementById("btnUnitPicker").addEventListener("click",function(){fe()}),document.getElementById("btnReview2").addEventListener("click",function(){$t()})}else if(r.screen==="ranking")e.innerHTML=Qe(),hn(e);else if(r.screen==="ranking-room")e.innerHTML=vn(),yn(e);else if(r.screen==="unitPicker")e.innerHTML=sn(),ln(e);else if(r.screen==="studyLoading")e.innerHTML=_n();else if(r.screen==="study")e.innerHTML=Bn(),An(e);else if(r.screen==="lesson")e.innerHTML=tn(),an(e);else if(r.screen==="battle")e.innerHTML=on(),document.getElementById("btnHome").addEventListener("click",function(){r.curQ=null,r.screen="map",Y()}),document.getElementById("btnReview").addEventListener("click",function(){Kn(r.stageIndex,!0)}),be(e);else if(r.screen==="endless")e.innerHTML=cn(),document.getElementById("btnHome").addEventListener("click",function(){r.curQ=null,r.screen="map",Y()}),document.getElementById("btnEndlessFilter").addEventListener("click",function(){r.curQ=null,fe()}),document.getElementById("btnPauseEndless").addEventListener("click",function(){H(t),r.curQ=null,r.screen="map",Y()}),be(e);else if(r.screen==="endless-result")e.innerHTML=dn(),document.getElementById("btnHome").addEventListener("click",function(){r.curQ=null,r.screen="map",Y()}),document.getElementById("btnEndlessAgain").addEventListener("click",function(){r.curQ=null,$e(),r.screen="endless",Y()}),document.getElementById("btnEndlessSettings").addEventListener("click",function(){r.curQ=null,fe()});else if(r.screen==="review"){e.innerHTML=vr();var u=document.getElementById("btnHome");u&&u.addEventListener("click",function(){r.curQ=null,r.screen="map",Y()});var b=document.getElementById("btnMap");b&&b.addEventListener("click",function(){r.curQ=null,r.screen="map",Y()});var f=document.getElementById("btnReviewAgain");f&&f.addEventListener("click",function(){$t()}),document.getElementById("qcard")&&be(e)}else if(r.screen==="result-win"||r.screen==="result-lose"){var y=r.screen==="result-win";e.innerHTML=hr(y);var g=document.getElementById("btnReview");g&&g.addEventListener("click",function(){r.curQ=null,Kn(r.stageIndex,!1)});var P=document.getElementById("btnRetry");P&&P.addEventListener("click",function(){r.curQ=null,ye(r.stageIndex,r.startTier)});var E=document.getElementById("btnNext");E&&E.addEventListener("click",function(){r.curQ=null,ye(r.stageIndex+1,r.startTier)});var _=document.getElementById("btnMap");_&&_.addEventListener("click",function(){r.curQ=null,r.screen="map",Y()})}}function ki(){or(),Ve(),Y()}export{br as SECTION_TITLES,ki as boot,gr as currentReviewQuestion,_e as getCodexAchievements,Xn as openEndless,Kn as openLesson,$t as openReview,Y as render,cr as renderCodexPanel,mr as renderMap,hr as renderResult,vr as renderReview,dr as renderSoloMomentum,We as renderTopbar};
